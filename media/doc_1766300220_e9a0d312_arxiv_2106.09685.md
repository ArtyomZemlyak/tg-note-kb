...
**File:** doc_1766300220_e9a0d312_arxiv_2106.09685.pdf
**Original:** arxiv_2106.09685.pdf
**Received:** 1766300220
...
|-----------------------|--------------------|---------|---------|---------|-------|------------|
| WikiSQL( ± 0 . 5 %)   | W q W q ,W v       |    68.8 |    69.6 |    70.5 |  70.4 |       70   |
...
Example:
```markdown
![Description based on OCR](../media/doc_1766300220_e9a0d312_arxiv_2106.09685.pdf) <!-- TODO: Broken image path -->
