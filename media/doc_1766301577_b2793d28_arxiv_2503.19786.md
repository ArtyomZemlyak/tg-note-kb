...
**File:** doc_1766301577_b2793d28_arxiv_2503.19786.pdf
**Original:** arxiv_2503.19786.pdf
**Received:** 1766301577
...
Here's the breakdown of the cost anda the tip calculation, based on the

1. Identify the cost of the sliced meat:
2. e The receipt lists "1x Zurcher Geschnetzelites + Rosti" at CHF 36.50. This Is the sliced meat dish with a side of Rosti (fried potatoes).
2. Caiculate the 18% tip:
4. ¢ Tip amount = CHF 36.50 * 0.18 = CHF 6.57
...
Example:
```markdown
![Description based on OCR](../media/doc_1766301577_b2793d28_arxiv_2503.19786.pdf) <!-- TODO: Broken image path -->
