...
**File:** doc_1766406453_046c6d9e_arxiv_2512.10430.pdf
**Original:** arxiv_2512.10430.pdf
**Received:** 1766406453
...
- T-Wix , the largest open Russian hybridreasoning SFT dataset to date ( ≈ 500 k samples) covering general instruction following, long-context tasks, and teacher-generated reasoning traces.
...
- An interactive web demo that exposes T-pro 2.0 as a research-oriented live system 1,2 , enabling side-by-side comparison of reasoning and non-reasoning modes, running tasks from our datasets and benchmarks, and viewing telemetry for inference-time optimizations.

1 The interactive demonstration interface is publicly accessible at http://t-pro-2-0.streamlit.app

2 The web demo video is available on YouTube.
...
The development of Russian LLMs primarily follows two tracks: monolingual pre-training and adaptation of multilingual models. Early decoderonly baselines like ruGPT (Kuratov and Arkhipov, 2019; Zmitrovich et al., 2023) and commercial systems such as YandexGPT 3 and GigaChat (Mamedov et al., 2025) focus on Russian-centric pretraining. While achieving promising results on Russian benchmarks, early versions face a capability gap compared to leading multilingual LLMs like Qwen (Yang et al., 2024) and Llama (Dubey et al., 2024).

To mitigate these limitations, T-pro 1.0 4 adopts a continued pre-training strategy on large-scale Russian corpora, reaching state-of-the-art results on MERA (Fenogenova et al., 2024) among open Russian models. Its release aligns with a broader shift toward strengthening open-source Russian LLMs, alongside projects such as Saiga (Gusev, 2023), RuAdapt (Tikhomirov and Chernyshev, 2024), and Vikhr (Nikolich et al., 2024). These works emphasize the value of mitigating English-centric tokenizer limitations (Petrov et al., 2024) and extending pre-training on Russian data. This direction continues to grow: although YandexGPT-5-Lite 5 is a fully pre-trained model rather than an adaptation, its recent open release further expands the set of publicly available Russian foundation models.

Russian Instruction Datasets. Existing Russian instruction datasets vary in provenance and domain coverage. Saiga (Gusev, 2023) applies self-instruct (Wang et al., 2023) pipelines producing ru\_turbo\_saiga, GrandMaster-PROMAX (Nikolich et al., 2024) aggregates sources across coding and general knowledge, and RuAdapt (Tikhomirov and Chernyshev, 2024) combines translated and native Russian samples. However, these datasets are usually small and contain few reasoning-intensive tasks.

3 https://ya.ru/ai/gpt

4 https://huggingface.co/t-tech/T-pro-it-1.0

5 https://huggingface.co/yandex/
...
|   T-pro |   Qwen3 |   GigaChat † |   Ruadapt-Qwen3 |
|---------|---------|--------------|-----------------|
|    2.71 |    3.63 |         2.89 |            3.26 |
...
|----------------------|-----------|---------------------|
| STEM &Business †     |      1.99 |                3.57 |
| Social &Humanities ‡ |      1.62 |                2.88 |
| Average              |      1.79 |                3.19 |
...
| Model                                        | MERA MaMuRAMu ruMMLU-Pro                     | MERA MaMuRAMu ruMMLU-Pro                     | MERA MaMuRAMu ruMMLU-Pro                     | Arena Hard Ru                                | WildChat Hard Ru                             | Arena Hard 2 HP CW                           | Arena Hard 2 HP CW                           |
|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|
| Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           |
...
| RuadaptQwen3-32B-Instruct 1                  | 0.574                                        | 0.823                                        | 0.652                                        | 68.4 / 64.76                                 | 41.5 / 39.4                                  | 13 / 14.2                                    | 19.4 / 12.7                                  |
| Gemma 3 27B 2                                | 0.577                                        | 0.808                                        | 0.665                                        | 82.66                                        | 58.4                                         | 23.5                                         | 74.7                                         |
| DeepSeek-R1-Distill-Qwen-32B 3               | 0.508                                        | 0.787                                        | 0.537                                        | 34.07 / 22.83                                | 12.1 / 8.7                                   | 7.2 / 7.2                                    | 5.9 / 3.5                                    |
| Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models |
| DeepSeek-V3                                  | 0.677                                        | 0.875                                        | 0.736                                        | 92.67                                        | 66.8                                         | 45.8                                         | 59.9                                         |
| DeepSeek-R1 3                                | -                                            | -                                            | -                                            | 95.74                                        | 90.3                                         | 73.6                                         | 90.3                                         |
| YandexGPT5-Pro 4                             | -                                            | -                                            | 0.604                                        | 19.13                                        | 12.1                                         | 3.8                                          | 2.6                                          |
| GigaChat 2 Max 5                             | 0.67                                         | 0.864                                        | 0.649                                        | 61.44                                        | 10.1                                         | 8.5                                          | 27.1                                         |
| o4-mini 6 (medium)                           | -                                            | -                                            | -                                            | 95.63                                        | 74.4                                         | 67                                           | 49.8                                         |
| GPT-4o 7                                     | 0.642                                        | 0.874                                        | 0.714                                        | 85.14                                        | 41.4                                         | 20.0                                         | 44.2                                         |

1 Tikhomirov and Chernyshev (2024), 2 Team et al. (2025), 3 DeepSeek-AI et al. (2025a), 4 https://ya.ru/ai/gpt ,

5 Mamedov et al. (2025), 6 OpenAI (2025), 7 OpenAI et al. (2024).
...
|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|----------------------------------------------|
| Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           | Open Source Models (27B-32B class)           |
| T-pro 2.0 (Ours)                             | 0.541                                        | 0.704                                        | 0.646                                        | 0.94                                         | 0.591                                        | 0.563                                        | 0.799                                        | 0.51                                         |
| Qwen3-32B                                    | 0.529                                        | 0.706                                        | 0.625                                        | 0.938                                        | 0.606                                        | 0.537                                        | 0.809                                        | 0.531                                        |
...
| DeepSeek-R1-Distill-Qwen-32B                 | 0.254                                        | 0.510                                        | 0.402                                        | 0.898                                        | 0.631                                        | 0.493                                        | 0.462                                        | 0.286                                        |
| Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models |
| DeepSeek-V3                                  | 0.278                                        | 0.319                                        | 0.285                                        | 0.882                                        | 0.657                                        | 0.444                                        | 0.613                                        | 0.367                                        |
| DeepSeek-R1                                  | 0.619                                        | 0.800                                        | 0.800                                        | 0.972                                        | 0.763                                        | 0.69                                         | 0.864                                        | 0.469                                        |
...
| o4-mini (medium)                             | 0.634                                        | 0.781                                        | 0.771                                        | 0.958                                        | 0.773                                        | 0.705                                        | 0.834                                        | 0.408                                        |
...
2. Amro Abbas, Kushal Tirumala, Dániel Simig, Surya Ganguli, and Ari S. Morcos. 2023. Semdedup: Dataefficient learning at web-scale through semantic deduplication. arXiv preprint arXiv:2303.09540 .
3. Berk Atil, Sarp Aykent, Alexa Chittams, Lisheng Fu, Rebecca J. Passonneau, Evan Radcliffe, Guru Rajan Rajagopal, Adam Sloan, Tomasz Tudrej, Ferhan Ture, Zhe Wu, Lixinyu Xu, and Breck Baldwin. 2025. Nondeterminism of "deterministic" llm settings. Preprint , arXiv:2408.04667.
4. Shuai Bai, Keqin Chen, Xuejing Liu, Jialin Wang, Wenbin Ge, Sibo Song, Kai Dang, Peng Wang, Shijie Wang, Jun Tang, Humen Zhong, Yuanzhi Zhu, Mingkun Yang, Zhaohai Li, Jianqiang Wan, Pengfei Wang, Wei Ding, Zheren Fu, Yiheng Xu, and 8 others. 2025. Qwen2.5-vl technical report. Preprint , arXiv:2502.13923.
...
6. RALPH ALLAN BRADLEY and MILTON E. TERRY. 1952. Rank analysis of incomplete block designs: The method of paired comparisons. Biometrika , 39(34):324-345.
7. Charlie Chen, Sebastian Borgeaud, Geoffrey Irving, Jean-Baptiste Lespiau, Laurent Sifre, and John Jumper. 2023. Accelerating large language model decoding with speculative sampling. Preprint , arXiv:2302.01318.
8. Yang Chen, Zhuolin Yang, Zihan Liu, Chankyu Lee, Peng Xu, Mohammad Shoeybi, Bryan Catanzaro, and Wei Ping. 2025. Acereason-nemotron: Advancing math and code reasoning through reinforcement learning. arXiv preprint arXiv:2505.16400 .
9. Peng Cui and Mrinmaya Sachan. 2025. Investigating the zone of proximal development of language models for in-context learning. Preprint , arXiv:2502.06990.
10. DeepSeek-AI, Daya Guo, Dejian Yang, Haowei Zhang, Junxiao Song, Ruoyu Zhang, Runxin Xu, Qihao Zhu, Shirong Ma, Peiyi Wang, Xiao Bi, Xiaokang Zhang,
11. Xingkai Yu, Yu Wu, Z. F. Wu, Zhibin Gou, Zhihong Shao, Zhuoshu Li, Ziyi Gao, and 181 others. 2025a. Deepseek-r1: Incentivizing reasoning capability in llms via reinforcement learning. Preprint , arXiv:2501.12948.
12. DeepSeek-AI, Aixin Liu, Bei Feng, Bing Xue, Bingxuan Wang, Bochao Wu, Chengda Lu, Chenggang Zhao, Chengqi Deng, Chenyu Zhang, Chong Ruan, Damai Dai, Daya Guo, Dejian Yang, Deli Chen, Dongjie Ji, Erhang Li, Fangyun Lin, Fucong Dai, and 181 others. 2025b. Deepseek-v3 technical report. Preprint , arXiv:2412.19437.
13. Abhimanyu Dubey, Abhinav Jauhri, Abhinav Pandey, and 1 others. 2024. The Llama 3 herd of models. arXiv preprint arXiv:2407.21783 .
14. Alena Fenogenova, Artem Chervyakov, Nikita Martynov, Anastasia Kozlova, Maria Tikhonova, Albina Akhmetgareeva, Anton Emelyanov, Denis Shevelev, Pavel Lebedev, Leonid Sinev, Ulyana Isaeva, Katerina Kolomeytseva, Daniil Moskovskiy, Elizaveta Goncharova, Nikita Savushkin, Polina Mikhailova, Anastasia Minaeva, Denis Dimitrov, Alexander Panchenko, and Sergey Markov. 2024. Mera: A comprehensive llm evaluation in russian. arXiv preprint arXiv:2401.04531 .
15. Fabian Gloeckle, Badr Youbi Idrissi, Baptiste Rozière, and 1 others. 2024. Better &amp; faster large language models via multi-token prediction. arXiv preprint arXiv:2404.19737 .
16. Shiyang Gu and 1 others. 2024. Sglang: Efficient serving of llms with speculative decoding and continuous batching. GitHub repository.
17. Igor Gusev. 2023. Saiga: Instruction-tuned russian llama models. https://huggingface.co/ IlyaGusev/saiga .
18. Dan Hendrycks and 1 others. 2021. Measuring mathematical problem solving with the math dataset. arXiv preprint arXiv:2103.03874 .
19. Hugging Face. 2025. Open r1: A fully open reproduction of deepseek-r1.
20. Shawn Im and Sharon Li. 2025. Can dpo learn diverse human values? a theoretical scaling law. Preprint , arXiv:2408.03459.
...
|-------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|
| T-pro 2.0 EAGLE weights T-Math T-Wix 500k | Model Model component Benchmark dataset Instruction corpus | https://huggingface.co/t-tech/T-pro-it-2.0 https://huggingface.co/t-tech/T-pro-it-2.0-eagle https://huggingface.co/datasets/t-tech/T-math https://huggingface.co/datasets/t-tech/T-Wix | Apache-2.0 Apache-2.0 Apache-2.0 ODC-By |
...
| Corpus                | Tokenizer   |   tok/ word |   1 tok (%) |   ≤ 2 tok (%) |   >2 tok (%) |
|-----------------------|-------------|-------------|-------------|---------------|--------------|
| Russian ruWiki ruWiki | Qwen3       |        3.12 |        20.3 |          38.2 |         61.8 |
|                       | T-pro 2.0   |        2.38 |        28.7 |          60.1 |         39.9 |
| T-Wix                 | Qwen3       |        2.7  |        31.8 |          52.4 |         47.6 |
| T-Wix                 | T-pro 2.0   |        2.26 |        39.3 |          65.5 |         34.5 |
| English enWiki        | Qwen3       |        1.68 |        61.2 |          83.7 |         16.3 |
...
|      | Tokens/Word   | Tokens/Word   | %Words ( ≤ 2 tok)   | %Words ( ≤ 2 tok)   |
|------|---------------|---------------|---------------------|---------------------|
| Lang | Qwen3         | T-pro         | Qwen3               | T-pro               |
...
|--------|---------|--------------|-----------------|-----------|
| ru     |    2.38 |         2.49 |            2.43 |      2.7  |
| uk     |    2.8  |         3.09 |            3.29 |      2.92 |
| be     |    2.94 |         3.32 |            3.54 |      3.03 |
| bg     |    2.35 |         2.58 |            2.5  |      2.56 |
| sr     |    2.62 |         2.97 |            3.07 |      2.73 |
| mk     |    2.41 |         2.67 |            2.7  |      2.59 |
| kk     |    3.07 |         2.67 |            4.6  |      3.11 |
| ky     |    3.09 |         3.33 |            3.97 |      3.17 |
...
|-------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| Global batch size (tokens) Total tokens Steps Max context length                                                  | 4M (128 seq × 32K) 40B ≈ 9 , 750 32K                                                                                    |
| Optimizer Adam betas Adam ϵ Weight decay LR schedule Peak / min LR Warmup Gradient clipping Precision Parallelism | AdamW (0 . 9 , 0 . 95) 10 - 8 10 - 6 cosine 1 × 10 - 5 / 1 × 10 - 6 100 batches max norm 1.0 BF16 FSDP full-shard, act. |
...
| ruLCB                     |   0.53 |     0.55 |
| T-Math                    |   0.49 |     0.5  |
| Arena hard (think)        |  43.7  |    44.5  |
| Arena wildchat ru (think) |  55    |    55.1  |
...
## Tokenizer adaptation and MERA results A

key objective of midtraining is to adapt the model to a new, denser tokenizer for Russian without degrading downstream quality. To quantify the impact of the tokenizer choice, we train two 8B models on the same midtraining datamix with identical optimization hyperparameters, differing only in the tokenizer (original Qwen3 vs. T-pro 2.0).

Table 13 reports MERA scores for these two variants. The T-pro 2.0 tokenizer attains a macroaverage score comparable to the original one (0.574 vs. 0.560), with only small per-task differences in both directions. In other words, replacing the tokenizer with a denser Cyrillic segmentation does not degrade general Russian-language performance on MERA, which is the primary design goal of midtraining.
...
|------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| USE MaMuRaMu ruWorldTree ruCodeEval RCB MathLogicQA ruOpenBookQA RWSD CheGeKa LCS PARUS MultiQ ruMultiAr ruTiE ruModAr | 0.198 0.784 0.966/0.966 0.173/0.45/0.585 0.557/0.479 0.710 0.897/0.897 0.446 0.30/0.368 0.102 0.868 0.381/0.517 0.402 0.788 0.515 | 0.191 0.796 0.966/0.966 0.454/0.689/0.756 0.564/0.47 0.731 0.922/0.923 0.250 0.31/0.384 0.096 0.912 0.344/0.478 0.400 0.798 0.627 |
| AVG                                                                                                                    | 0.560                                                                                                                             | 0.574                                                                                                                             |

The midtraining loss curve in Figure 3 further illustrates the adaptation process. Training loss decreases sharply over the first ≈ 1 k steps ( ≈ 4 B tokens) before plateauing, indicating that a substantial token budget at a relatively high learning rate is required to adapt the model to the new tokenizer beyond what the smaller, lower-LR SFT budget alone could provide.
...
Initial Pool Generation and Deduplication. The initial pool of data is constructed from approx- imately 450k high-quality English-language reasoning instructions, drawn from established opensource datasets (e.g., Open-R1 (Hugging Face, 2025), Nvidia/AceReason-Math (Chen et al., 2025), Nvidia/Nemotron (Bercovich et al., 2025)), covering general knowledge, mathematics, natural sciences, and code generation.
...
## Statistical Filtering Based on Reward Stability.

Instructions exhibiting high variance in RM scores across generations are discarded, as they reflect ambiguous or unstable evaluation signals. Additionally, instructions for which the student model consistently receives very low RM scores-even
...
## Tournament-Based Synthetic Preference Data
...
At the completion of each single-elimination tournament with n participants, a total of n 2 log 2 N preference pairs are obtained. This result comes from the hierarchical structure of the tournament: in each round, half of the remaining participants compete, producing n 2 new pairwise outcomes (both direct and transitive). Because a tournament with n participants requires log 2 N rounds to determine a winner, the total number of inferred prefer-

ence pairs accumulates to n 2 log 2 N .
...
This process produces preference set dense enough to capture comparative information among many participants, yet far more efficient than exhaustively comparing every possible pair (which would require n ( n -1) 2 comparisons). This tournament-based approach yields an informative preference dataset while significantly reducing annotation complexity.
...
Evaluation For intrinsic evaluation, we adapt RewardBench 2 (Malik et al., 2025) to Russian by translating the original benchmark and report standard leaderboard metrics. For downstream evaluation, we additionally construct a Best-ofN selection benchmark on top of the Arena-Hard-RU instruction set to assess the reward model under realistic generation scenarios. In this setting, the base model produces N candidate completions per instruction, and the reward model selects the highestscoring (best@N) and lowest-scoring (worst@N) outputs. These selections are then evaluated using Arena-Hard, allowing us to measure the alignment between reward-model rankings and externally validated quality. We further report the ∆ BoN metric (best@N - worst@N) to quantify discriminative capacity. Although our model performs compara- bly to existing open-source reward models on the translated RewardBench 2, it demonstrates a clear advantage on our Best-ofN Arena-Hard benchmark. As shown in Table 16, our model obtains the highest ∆ BoN score, reflecting the strongest separation between high- and low-quality completions.

Table 16: Best-ofN ( N = 8 ) evaluation on ArenaHard-RU. We report win rates for the highest- (best@8) and lowest-scoring (worst@8) completions selected by each reward model, and their difference ∆ BoN = best@8 -worst@8, which measures discriminative capacity. 1 Wang et al. (2025b), 2 Liu et al. (2024), 3 Liu et al. (2025a), 4 Malik et al. (2025)

| RM-model                                     | best@8 ↑      | worst@8 ↓     |   ∆ BoN |
|----------------------------------------------|---------------|---------------|---------|
| Qwen3-32B-RM (Ours)                          | 92.69 (-0.99) | 70.48 (+2.34) |   22.21 |
| Llama-3.3-Nemotron-70B-Reward-Multilingual 1 | 85.93 (-1.93) | 84.91 (+1.85) |    1.02 |
| Skywork-Reward-Gemma-2-27B 2                 | 89.05 (-1.6)  | 74.35 (+2.07) |   14.7  |
| Skywork-Reward-V2-Llama-3.1-8B 3             | 90.49 (-1.43) | 77.31 (+1.77) |   13.18 |
| Llama-3.1-Tulu-3-70B-SFT-RM-RB2 4            | 87.37 (-1.86) | 78.47 (+1.76) |    8.9  |
...
| Category                     | Model                                      | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   |
|------------------------------|--------------------------------------------|----------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|                              |                                            | Fact.                | Focus                | Math                 | Prec. IF             | Safety               | Total                |
| Comparison with Existing RMs | Qwen3-32B-RM (Ours)                        | 0.66                 | 0.87                 | 0.62                 | 0.42                 | 0.89                 | 0.69                 |
| Comparison with Existing RMs | Skywork-Reward-V2-Llama-3.1-8B             | 0.68                 | 0.88                 | 0.65                 | 0.45                 | 0.79                 | 0.69                 |
| Comparison with Existing RMs | Skywork-Reward-Gemma-2-27B                 | 0.69                 | 0.88                 | 0.64                 | 0.40                 | 0.92                 | 0.7                  |
| Comparison with Existing RMs | Llama-3.1-Tulu-3-70B-SFT-RM-RB2            | 0.72                 | 0.74                 | 0.69                 | 0.41                 | 0.76                 | 0.66                 |
| Comparison with Existing RMs | Llama-3.3-Nemotron-70B-Reward-Multilingual | 0.73                 | 0.85                 | 0.62                 | 0.41                 | 0.86                 | 0.69                 |
| Judge Model                  | Qwen-3-RM-8B-DeepSeek-V3                   | 0.478                | 0.756                | 0.598                | 0.341                | 0.736                | 0.581                |
| Ablation                     | Qwen-3-RM-8B-Qwen3-235B-A22B               | 0.467                | 0.324                | 0.688                | 0.350                | 0.840                | 0.533                |
| Transitive Samples           | Qwen3-8B-RM w/o transitive                 | 0.467                | 0.324                | 0.688                | 0.350                | 0.840                | 0.533                |
| Ablation                     | Qwen3-8B-RM w/ transitive                  | 0.505                | 0.453                | 0.704                | 0.413                | 0.860                | 0.587                |

Table 18: Assessing the role of prompt selection in RewardBench 2 (RU).

| Prompt        | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   | RewardBench 2 (RU)   |
|---------------|----------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|               | Fact.                | Focus                | Math                 | Prec. IF             | Safety               | Total                |
| Skywork       | 0.636                | 0.782                | 0.834                | 0.394                | 0.881                | 0.706                |
| Arena Hard    | 0.653                | 0.638                | 0.762                | 0.349                | 0.899                | 0.660                |
| Google Vertex | 0.741                | 0.846                | 0.830                | 0.549                | 0.915                | 0.776                |
...
|-------------|---------|----------|-----------|---------------------|
|             |     0   | No Think |      2.05 |                3.55 |
| ruMT-Bench  |     0   | Think    |      1.86 |                3.37 |
|             |     0.8 | No Think |      1.79 |                3.31 |
|             |     0.8 | Think    |      1.69 |                3.1  |
| ruAlpaca    |     0   | No Think |      1.78 |                3.23 |
| ruAlpaca    |     0   | Think    |      1.77 |                3.2  |
| ruAlpaca    |     0.8 | No Think |      1.61 |                2.94 |
| ruAlpaca    |     0.8 | Think    |      1.57 |                2.85 |
| ruCodeEval  |     0   | No Think |      2.26 |                4.09 |
| ruCodeEval  |     0   | Think    |      2.07 |                3.76 |
| ruCodeEval  |     0.8 | No Think |      2.15 |                3.93 |
| ruCodeEval  |     0.8 | Think    |      1.84 |                3.34 |
| T-Math      |     0   | Think    |      2.28 |                4.14 |
| T-Math      |     0.8 | Think    |      2.25 |                4.01 |
...
9 https://github.com/huggingface/Math-Verify
...
|   2 | Number theory / arithmetic constructions. Using any number of coins of denomi- nations 1, 2, 5 and 10 roubles, together with (free) parentheses and the four arithmetic operations, construct an expression whose value is 2009 , while spending as little money as possible. In the answer, write the minimum possible total value of the coins used (i.e., the minimum amount of money you need to 'spend').                                                                                           | 23       |
|   3 | Geometry, olympiad level. In triangle ABC with side lengths AB = 3 , BC = 4 , CA = 5 , we mark pairs of points on its sides: points C 1 and C 2 on side AB , points A 1 and A 2 on side BC , and points B 1 and B 2 on side CA . Inside triangle ABC there is a point P such that triangles PA 1 A 2 , PB 1 B 2 and PC 1 C 2 are congruent and equilateral. Find the area of the convex hexagon with vertices A 1 , A 2 , B 1 , B 2 , C 1 , C 2 . If necessary, round your answer to two decimal places. | 3 . 34   |
...
| T-pro 2.0 (Ours)                             | 0.765                                        | 0.679       | 0.966      | 0.641          | 0.556 |
...
| Open Source Larger Scale &Proprietary Models | Open Source Larger Scale &Proprietary Models |             |            |                |       |
| DeepSeek-V3                                  | 0.52                                         | 0.285       | 0.942      | 0.655          | 0.405 |
| DeepSeek-R1                                  | 0.914                                        | 0.875       | 0.983      | 0.813          | 0.770 |
| YandexGPT5-Pro                               | 0.117                                        | 0.090       | 0.776      | 0.434          | 0.272 |
| GigaChat 2 Max                               | 0.110                                        | 0.058       | 0.742      | 0.449          | 0.272 |
| o4-mini (medium)                             | 0.800                                        | 0.819       | 0.974      | 0.783          | 0.757 |
...
Example:
```markdown
![Description based on OCR](../media/doc_1766406453_046c6d9e_arxiv_2512.10430.pdf) <!-- TODO: Broken image path -->
