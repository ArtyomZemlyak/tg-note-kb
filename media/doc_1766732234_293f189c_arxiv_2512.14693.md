...
**File:** doc_1766732234_293f189c_arxiv_2512.14693.pdf
**Original:** arxiv_2512.14693.pdf
**Received:** 1766732234
...
where W dwconv ∈ R m × 1 × k is a depthwise convolution kernel of size k = 2 .
...
Example:
```markdown
![Description based on OCR](../media/doc_1766732234_293f189c_arxiv_2512.14693.pdf) <!-- TODO: Broken image path -->
