...
**File:** doc_1768120154_30d8f004_arxiv_2505.14146.pdf
**Original:** arxiv_2505.14146.pdf
**Received:** 1768120154
...
1 Code available at https://github.com/pat-jj/s3 .
...
Given a question Q , the system consists of (1) a search agent (LLM policy) π s3 , (2) a search engine R , (3) a frozen generator LLM G . s3 first retrieves topk documents using q 0 = Q , yielding D 0 = R ( Q ) . A subset D sel 0 ⊆ D 0 is selected to form the initial context. It then performs a sequence of search rounds t = 1 , 2 , . . . , T , structured as:
...
2 https://github.com/StonyBrookNLP/ircot

3 https://huggingface.co/DeepRetrieval/
...
SearchR1-nq\_hotpotqa\_train-qwen2.5-3b-em-ppo

,

https://huggingface.co/PeterJinGo/SearchR1-nq\_
...
6 https://github.com/volcengine/verl

7 https://github.com/RAGEN-AI/RAGEN
...
13 https://github.com/castorini/pyserini/blob/ master/pyserini/eval/evaluate\_dpr\_retrieval.py
...
14 (Anonymous) raw results of human-metric alignment study: https://docs.google.com/spreadsheets/d/e/ 2PACX-1vQ-aAC6FNJYFJk1Ca8-EGN1zHa5z8WoF0Fm2VIHoWO\_ CA0Gaa-f\_uy8JGX-NiRO9l2yDaJTxU0nObjG/pubhtml
...
Example:
```markdown
![Description based on OCR](../media/doc_1768120154_30d8f004_arxiv_2505.14146.pdf) <!-- TODO: Broken image path -->
