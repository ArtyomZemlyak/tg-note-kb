...
**File:** doc_1769229577_eab9c73a_arxiv_1412.6980.pdf
**Original:** arxiv_1412.6980.pdf
**Received:** 1769229577
...
Require: θ 0 : Initial parameter vector u 0 ← 0 (Initialize the exponentially weighted infinity norm)
...
while θ t not converged do g t ←∇ θ f t ( θ t -1 ) (Get gradients w.r.t. stochastic objective at timestep t )
...
Lemma 10.4. Let γ /defines β 2 1 √ β 2 . For β 1 , β 2 ∈ [0 , 1) that satisfy β 2 1 √ β 2 &lt; 1 and bounded g t , ‖ g t ‖ 2 ≤ G , ‖ g t ‖ ∞ ≤ G ∞ , the following inequality holds
...
We can rearrange the above equation and use Young's inequality, ab ≤ a 2 / 2 + b 2 / 2 . Also, it can be t t -j
...
Example:
```markdown
![Description based on OCR](../media/doc_1769229577_eab9c73a_arxiv_1412.6980.pdf) <!-- TODO: Broken image path -->
