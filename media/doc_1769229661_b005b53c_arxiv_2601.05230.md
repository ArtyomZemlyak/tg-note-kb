...
**File:** doc_1769229661_b005b53c_arxiv_2601.05230.pdf
**Original:** arxiv_2601.05230.pdf
**Received:** 1769229661
...
## 6 Whatkind of actions do we learn ?
...
- Justin Johnson, Alexandre Alahi, and Li Fei-Fei. Perceptual losses for real-time style transfer and superresolution. In European conference on computer vision , pages 694-711. Springer, 2016.
...
- Bo Liu, Yifeng Zhu, Chongkai Gao, Yihao Feng, Qiang Liu, Yuke Zhu, and Peter Stone. Libero: Benchmarking knowledge transfer for lifelong robot learning. Advances in Neural Information Processing Systems , 36:4477644791, 2023.
...
- Lingni Ma, Yuting Ye, Fangzhou Hong, Vladimir Guzov, Yifeng Jiang, Rowan Postyeni, Luis Pesqueira, Alexander Gamino, Vijay Baiyya, Hyo Jin Kim, et al. Nymeria: A massive collection of multimodal egocentric daily motion in the wild. In European Conference on Computer Vision , pages 445-465. Springer, 2024.
...
- Willi Menapace, Stéphane Lathuilière, Aliaksandr Siarohin, Christian Theobalt, Sergey Tulyakov, Vladislav Golyanik, and Elisa Ricci. Playable environments: Video manipulation in space and time. In Proceedings of the ieee/cvf conference on computer vision and pattern recognition , pages 3584-3593, 2022.

- Antoine Miech, Dimitri Zhukov, Jean-Baptiste Alayrac, Makarand Tapaswi, Ivan Laptev, and Josef Sivic. Howto100m: Learning a text-video embedding by watching hundred million narrated video clips. Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition , pages 2630-2640, 2019.
- Soroush Nasiriany, Abhiram Maddukuri, Lance Zhang, Adeet Parikh, Aaron Lo, Abhishek Joshi, Ajay Mandlekar, and Yuke Zhu. Robocasa: Large-scale simulation of everyday tasks for generalist robots. arXiv preprint arXiv:2406.02523 , 2024.
- Derrick Nguyen and Bernard Widrow. The truck backerupper: An example of self-learning in neural networks. In Advanced neural computers , pages 11-19. Elsevier, 1990.
...
- Dhruv Shah, Benjamin Eysenbach, Nicholas Rhinehart, and Sergey Levine. Rapid exploration for open-world navigation with latent goal models. In 5th Annual Conference on Robot Learning , 2021. https://openreview. net/forum?id=d\_SWJhyKfVw .
...
- Tianhe Yu, Deirdre Quillen, Zhanpeng He, Ryan Julian, Karol Hausman, Chelsea Finn, and Sergey Levine. Meta-world: A benchmark and evaluation for multitask and meta reinforcement learning. In Conference on robot learning , pages 1094-1100. PMLR, 2020.
...
- Sparsity : λ l 2 = 1 , λ V = 0 . 1 , λ C = 0 . 001 , λ M = 0 . 1 , λ 1 ∈ { 0 . 4 , 0 . 1 , 0 . 08 , 0 . 06 , 0 . 05 , 0 . 04 , 0 . 02 , 0 . 01 }
- Noisiness : β ∈ { 5 × 10 -3 , 1 × 10 -3 , 5 × 10 -4 , 1 × 10 -4 , 5 × 10 -5 , 1 × 10 -5 , 5 × 10 -6 , 1 × 10 -6 }
- Discretization : Commitment loss coefficient β = 0 . 25 , | C | ∈ { 16 , 1024 , 4096 , 32768 } , codebook reset for unused codes every 300k videos seen, equivalent to 2 . 5 million latent actions produced
...
Example:
```markdown
![Description based on OCR](../media/doc_1769229661_b005b53c_arxiv_2601.05230.pdf) <!-- TODO: Broken image path -->
