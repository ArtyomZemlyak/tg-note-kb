...
**File:** doc_1769437568_ef665204_arxiv_2601.05573.pdf
**Original:** arxiv_2601.05573.pdf
**Received:** 1769437568
...
1 Zhejiang University; 2 Shanghai AI Lab; 3 Sea AI Lab; 4 The University of Hong Kong https://orient-anythingv2.github.io/

<!-- image -->

<!-- image -->

Data : Scalable Data Engine

Model: Orient Anything V2

<!-- image -->

New Features: Symmetry &amp; Rotation
...
(a) Low-quality Texture

(b) Limited Pose&amp;Shape
...
where ¯ σ is the fitted variance. The phase ¯ ϕ ∈ [0 ◦ , 360 ◦ ) represents the main azimuth direction. The periodicity ¯ α ∈ { 1 , 2 , . . . , N } signifies 360 / ¯ α -degree rotational symmetry, possessing ¯ α valid front faces, while ¯ α = 0 indicates no dominant orientation.
...
| Model     | SUN-RGBD   | SUN-RGBD   | ARKitScenes   | ARKitScenes   | Pascal3D+   | Pascal3D+   | Objectron   | Objectron   | ImageNet3D †   | ImageNet3D †   | Ori_COCO   |
|-----------|------------|------------|---------------|---------------|-------------|-------------|-------------|-------------|----------------|----------------|------------|
| Model     | Med ↓      | Acc30° ↑   | Med ↓         | Acc30° ↑      | Med ↓       | Acc30° ↑    | Med ↓       | Acc30° ↑    | Med ↓          | Acc30° ↑       | Acc ↑      |
| OriAny.V1 | 33.94      | 48.5       | 77.58         | 35.8          | 22.90       | 55.0        | 30.67       | 49.6        | 13.34          | 71.3           | 72.4       |
| OriAny.V2 | 26.00      | 55.4       | 36.48         | 43.2          | 15.02       | 72.7        | 22.62       | 56.4        | 15.26          | 65.2           | 86.4       |
...
| Model                                            | LINEMOD                                          | LINEMOD                                          | LINEMOD                                          | YCB-Video                                        | YCB-Video                                        | YCB-Video                                        | OnePose++                                        | OnePose++                                        | OnePose++                                        | OnePose                                          | OnePose                                          | OnePose                                          |
|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|--------------------------------------------------|
| Model                                            | Med ↓                                            | Acc30 ↑                                          | Acc15 ↑                                          | Med ↓                                            | Acc30 ↑                                          | Acc15 ↑                                          | Med ↓                                            | Acc30 ↑                                          | Acc15                                            | Med ↓                                            | Acc30 ↑                                          | Acc15 ↑                                          |
| POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) | POPE's Sampling (Average rotation angle: 14.85°) |
...
| Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   | Random Sample (Average rotation angle: 78.22°)   |
...
|     |             |               |                     | Orientation Estimation   | Orientation Estimation   | Orientation Estimation   | Rotation Estimation   | Rotation Estimation   | Rotation Estimation   | Rotation Estimation   |
|-----|-------------|---------------|---------------------|--------------------------|--------------------------|--------------------------|-----------------------|-----------------------|-----------------------|-----------------------|
| Row | Assets Type | Assets Number | Initialized Weights | Objectron                | Objectron                | Ori_COCO                 | LINEMOD               | LINEMOD               | YCB-Video             | YCB-Video             |
...
- [12] Google. Gemini-2.0-flash, 2025. https://aistudio.google.com/prompts/new\_chat?model= gemini-2.0-flash-exp .
...
## A More Visualizations of Images in The Wild 1

- In 1 2, 3, 4, 5, 6, 7, we present more visualizations of images from various domains containing 2
- different objects. In these images, our model shows strong abilities in single-view absolute orientation 3
- estimation, powerful object horizontal rotational symmetry recognition and two-frame object relative 4
- pose rotation estimation, further highlighting the impressive zero-shot capability of Orient Anything 5
...
Example:
```markdown
![Description based on OCR](../media/doc_1769437568_ef665204_arxiv_2601.05573.pdf) <!-- TODO: Broken image path -->
