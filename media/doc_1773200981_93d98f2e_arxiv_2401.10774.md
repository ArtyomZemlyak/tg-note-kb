...
**File:** doc_1773200981_93d98f2e_arxiv_2401.10774.pdf
**Original:** arxiv_2401.10774.pdf
**Received:** 1773200981
...
* Equal contribution 1 Princeton University 2 Together AI 3 University of Illinois Urbana-Champaign 4 Carnegie Mellon University 5 University of Connecticut. Correspondence to: Tianle Cai &lt; tianle.cai@princeton.edu &gt; , Yuhong Li &lt; leeyh@illinois.edu &gt; .
...
- Combined loss : To keep the backbone model's next-token prediction capability, we need to add the cross-entropy loss of the backbone model L LM = (0)
- -log p t ( y t +1 ) to the MEDUSA loss. We also add a weight λ 0 to balance the loss of the backbone model and the MEDUSA heads. Therefore, the total loss is:
...
2 Here, the accuracy is defined for the single top i -th token, i.e., this accuracy is equal to topi accuracy minus top-( i -1) accuracy.
...
3 https://github.com/feifeibear/LLMSpeculativeSampling
...
Example:
```markdown
![Description based on OCR](../media/doc_1773200981_93d98f2e_arxiv_2401.10774.pdf) <!-- TODO: Broken image path -->
