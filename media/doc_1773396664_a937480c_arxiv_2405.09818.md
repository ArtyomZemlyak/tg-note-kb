...
**File:** doc_1773396664_a937480c_arxiv_2405.09818.pdf
**Original:** arxiv_2405.09818.pdf
**Received:** 1773396664
...
Text/Image Interleaved: We procure data from publicly available web sources, not including data from Meta's products or services, for a total of 400billion tokens of interleaved text and image data similar to Laurençon et al. (2023). We apply the same filtering for images, as was applied in Text-To-Image .
...
Optimization Our training process uses the AdamW optimizer (Loshchilov and Hutter, 2017), with β 1 set to 0.9 and β 2 to 0.95, with an ϵ = 10 -5 . We use a linear warm-up of 4000 steps with an exponential decay schedule of the learning rate to 0. Additionally, we apply a weight decay of 0.1 and global gradient clipping at a threshold of 1.0. We use a dropout of 0.1 (Srivastava et al., 2014) for Chameleon-7B for training stability, but not for Chameleon-34B (see Figure 5c and 6c).

The application of QK-Norm while helping the inner softmaxes within the Transformer does not solve the problem of logit shift in the final softmax. Following Chowdhery et al. (2022); Wortsman et al. (2023), we apply z-loss regularization. Specifically, we regularize the partition function Z of the softmax function σ ( x ) i = e x i Z where Z = ∑ i e x i by adding 10 -5 log 2 Z to our loss function.
...
Chameleon-7B was trained with a global batch size of 2 23 ( ∼ 8 M) tokens and Chameleon-34B was trained with a global batch size of 3 × 2 22 ( ∼ 12 M) tokens. We do 2.1 epochs over our full training dataset for a total
...
|-----------|----------|------------------|-------|----------|----------------|----------|-----------|---------|----------|
| LLaMa-1   | 7B       | 2k               | ×     | 1.0T     | 3 . 0 × 10 - 4 |      1   |       0   | 0.0     | ×        |
|           | 33B      | 2k               | ×     | 1.4T     | 1 . 5 × 10 - 4 |      1   |       0   | 0.0     | ×        |
| LLaMa-2   | 7B       | 4k               | ×     | 2.0T     | 3 . 0 × 10 - 4 |      1   |       0   | 0.0     | ×        |
|           | 34B      | 4k               | ✓     | 2.0T     | 1 . 5 × 10 - 4 |      1   |       0   | 0.0     | ×        |
| Chameleon | 7B       | 4k               | ×     | 4.4T     | 1 . 0 × 10 - 4 |      2.1 |       0.1 | 10 - 5  | ✓        |
|           | 34B      | 4k               | ✓     | 4.4T     | 1 . 0 × 10 - 4 |      2.1 |       0   | 10 - 5  | ✓        |
...
| Chameleon-SFT | Code                   | 14.1K         | 1.1M         | -            |
| Chameleon-SFT | Visual Chat            | 15.6K         | 19.4M        | 16.7K        |
| Chameleon-SFT | Image Generation       | 64.3K         | 68.0M        | 64.3K        |
| Chameleon-SFT | Interleaved Generation | 16.9K         | 35.8M        | 30.7K        |
| Chameleon-SFT | Safety                 | 95.3K         | 38.6M        | 1.6K         |
...
Prompt: Given a list of integers, find the first number that appears at least twice. Response: def find\_duplicate(my\_list): seen = set() for num in my\_list: if num in seen: return num seen.add(num) return None
...
## 4 HumanEvaluations and Safety Testing
...
2 The win rate is calculated by adding 1 point for a win and 0.5 points for a tie.
...
|--------------|----------|-------------|-----------|-----------|
| Crowdsourced | 7B 34B   | 99.2% 99.7% | 0.4% 0.1% | 0.4% 0.2% |
...
|                                                | Chameleon                                      | Chameleon                                      | Llama-2                                        | Llama-2                                        | Llama-2                                        | Mistral                                        | Mistral                                        | Gemini Pro                                     | GPT- 4                                         |
|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|
|                                                | 7B                                             | 34B                                            | 7B                                             | 34B                                            | 70B                                            | 7B                                             | 8x7B                                           | -                                              | -                                              |
| CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension | CommonsenseReasoning and Reading Comprehension |
...
| Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       | Math and World Knowledge                       |
| GSM8k                                          | 41.6                                           | 61.4                                           | 14.6                                           | 42.2                                           | 56.8                                           | 52.1 maj@8                                     | 74.4 maj@8                                     | 86.5 maj@32 CoT                                | 92.0 SFT                                       |
|                                                | 50.9 maj@8                                     | 77.0 maj@32                                    | -                                              | -                                              | -                                              | -                                              | 75.1 ∗ maj@32                                  | -                                              | CoT -                                          |
...
|-------------------------------------------|---------------------------------|--------------|-------------------------------|-------------------------|---------------------------|
| Pre-trained                               | Flamingo-80B IDEFICS-80B        | 80B 80B      | 113.8 32-shot 116.6 32-shot   | 75.1 4-shot 73.7 4-shot | 67.6 32-shot 65.9 32-shot |
| Chameleon                                 | Chameleon Chameleon-SFT         | 34B 34B      | 120.2 2-shot 140.8 0-shot     | 74.7 2-shot 82.3 2-shot | 66.0 2-shot -             |
| Fine-tuned                                | Flamingo-80B-FT                 | 80B          | 138.1 123.2                   | 76.2 2-shot             |                           |
|                                           | Chameleon-MultiTask             | 34B          | 139.1 2-shot                  | -                       | 69.6                      |
|                                           | IDEFICS-80B-Instruct            | 80B          | 32-shot                       | 78.4 32-shot            | 82.0 68.8 32-shot         |
| Closed Source (finetuning status unknown) | GPT-4V Gemini Nano 2 Gemini Pro | - - -        | 78.5 ∗ 8-shot - 99.8 ∗ 2-shot | 55.3 ∗ 8-shot - 82.2 ∗  | 77.2 67.5 71.2            |
| Closed Source (finetuning status unknown) |                                 |              |                               | 4-shot                  |                           |
| Closed Source (finetuning status unknown) | Gemini Ultra                    | -            | -                             | -                       | 77.8                      |
...
| Task Type      | Chameleon   | Chameleon          | Chameleon        | Gemini+   | Gemini+            | Gemini+          | GPT-4V+   | GPT-4V+            | GPT-4V+          |
|----------------|-------------|--------------------|------------------|-----------|--------------------|------------------|-----------|--------------------|------------------|
...
| Task Type      | Fulfills   | Gemini Partially fulfills   | Does not fulfill   | Fulfills   | GPT-4V Partially fulfills   | Does not fulfill   |
|----------------|------------|-----------------------------|--------------------|------------|-----------------------------|--------------------|
...
|                | Fulfills    | Chameleon Partially fulfills   | Does not fulfill   | Fulfills       | Gemini+ Partially fulfills   | Does not fulfill   | Fulfills    | GPT-4V+ Partially fulfills   | Does not fulfill   |
|----------------|-------------|--------------------------------|--------------------|----------------|------------------------------|--------------------|-------------|------------------------------|--------------------|
| Mixed-modality | 55.3% 57.7% | 36.7% 38.4%                    | 7.9% 4.0%          | 39.2%          | 57.8% 55.5%                  | 2.9% 8.1%          | 42.6% 46.1% | 52.4% 42.7%                  | 5.0% 11.2%         |
| Text-only      | Fulfills    | Gemini Partially fulfills      | Does not fulfill   | 36.4% Fulfills | GPT-4V Partially fulfills    | Does not fulfill   |             |                              |                    |
...
Example:
```markdown
![Description based on OCR](../media/doc_1773396664_a937480c_arxiv_2405.09818.pdf) <!-- TODO: Broken image path -->
