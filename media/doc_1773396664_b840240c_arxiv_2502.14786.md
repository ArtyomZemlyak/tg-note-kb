...
**File:** doc_1773396664_b840240c_arxiv_2502.14786.pdf
**Original:** arxiv_2502.14786.pdf
**Received:** 1773396664
...
1 Model checkpoints are available at

https://github.com/google-research/big\_vision/tree/main/ big\_vision/configs/proj/image\_text/README\_siglip2.md
...
As for the fixed-resolution, adapted variants, westart from the default checkpoints trained with the setup described in Sec. 2.2, i.e. with nonaspect preserving resize to 256px, resulting in a sequence length of 256. We take the checkpoint at 90% training completion, then switch to aspect-

SigLIP 2: Multilingual Vision-Language Encoders with Improved Semantic Understanding, Localization, and Dense Features

|       |      |      |                         | ImageNet-1k   | ImageNet-1k   | ImageNet-1k   | ImageNet-1k   |           | COCO      | COCO      | Flickr    | Flickr    | XM3600    | XM3600    |
|-------|------|------|-------------------------|---------------|---------------|---------------|---------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| ViT   | Res. | Seq. | Model                   | val           | v2            | ReaL          | ObjNet        | 10s.      | T → I     | I → T     | T → I     | I → T     | T → I     | I → T     |
| B/32  | 224  | 49   | MetaCLIP [66]           | 67.7          | 59.6          | -             | 52.8          | -         | 46.6      | -         | 72.9      | -         | -         | -         |
|       |      |      | OpenCLIP [27]           | 72.8          | 64.8          | -             | 59.6          | -         | 39.9      | 57.9      | 64.9      | 84.8      | -         | -         |
|       | 256  | 64   | SigLIP 2                | 74.0          | 66.9          | 81.4          | 66.1          | 66.6      | 47.2      | 63.7      | 75.5      | 89.3      | 38.3      | 49.0      |
|       |      |      | CLIP [50]               | 68.3          | 61.9          | -             | 55.3          | -         | 33.1      | 52.4      | 62.1      | 81.9      | -         | -         |
|       |      |      | OpenCLIP [27]           | 70.2          | 62.3          | -             | 56.0          | -         | 42.3      | 59.4      | 69.8      | 86.3      | -         | -         |
|       |      |      | MetaCLIP [66]           | 72.4          | 65.1          | -             | 60.0          | -         | 48.9      | -         | 77.1      | -         | -         | -         |
|       | 224  | 196  | EVA-CLIP [57]           | 74.7          | 67.0          | -             | 62.3          | -         | 42.2      | 58.7      | 71.2      | 85.7      | -         | -         |
|       | 224  |      | SigLIP [71]             | 76.2          | 69.5          | 82.8          | 70.7          | 69.9      | 47.2      | 64.5      | 77.9      | 89.6      | 22.4      | 29.3      |
|       | 224  |      | DFN [19]                | 76.2          | 68.2          | -             | 63.2          | -         | 51.9      | -         | 77.3      | -         | -         | -         |
| B/16  |      |      | SigLIP 2                | 78.2          | 71.4          | 84.8          | 73.6          | 72.1      | 52.1      | 68.9      | 80.7      | 93.0      | 40.3      | 50.7      |
|       |      | 256  | SigLIP [71]             | 76.7          | 70.1          | 83.1          | 71.3          | 70.3      | 47.4      | 65.1      | 78.3      | 91.1      | 22.5      | 29.9      |
...
|       |      | 256  | OpenCLIP [27] CLIP [50] | 74.0 75.5     | 61.1 69.0     | - -           | 66.4 69.9     | - -       | 46.1 36.5 | 62.1 56.3 | 75.0 65.2 | 88.7 85.2 | - -       | - -       |
|       |      |      | MetaCLIP [66]           | 79.2          | 72.6          | -             | 74.6          | -         | 55.7      | -         | 83.3      | -         | -         | -         |
| L/14  | 224  |      | CLIPA-v2 [33]           | 79.7          | 72.8          | -             | 71.1          | -         | 46.3      | 64.1      | 73.0      | 89.1      | -         | -         |
|       |      |      | EVA-CLIP [57]           | 79.8          | 72.9          | -             | 75.3          | -         | 47.5      | 63.7      | 77.3      | 89.7      | -         | -         |
|       |      |      | DFN [19]                | 82.2          | 75.7          | -             | 74.8          | -         | 59.6      | -         | 84.7      | -         | -         | -         |
|       | 256  |      | SigLIP [71]             | 80.5          | 74.2          | 85.9          | 77.9          | 76.8      | 51.2      | 69.6      | 81.3      | 92.0      | 30.9      | 40.1      |
|       |      | 256  | SigLIP 2                | 82.5          | 76.8          | 87.3          | 83.0          | 78.8      | 54.7      | 71.5      | 84.1      | 94.5      | 46.5      | 56.5      |
...
|       | 512  | 1024 | SigLIP 2                | 83.5 82.2     | 77.8          | 87.7          | 84.6          | 79.6      | 55.2      | 72.1      | 85.3      | 95.8      | 47.4      | 56.7      |
|       | 224  | 256  | SigLIP [71] SigLIP 2    | 83.2          | 76.0 77.7     | 87.1 87.8     | 80.5 84.6     | 78.2 79.5 | 50.8 55.1 | 69.0 71.5 | 76.6 84.3 | 90.7 94.6 | 16.0 47.9 | 22.8 57.5 |
| So/14 |      |      | SigLIP [71]             | 83.2          |               |               | 82.9          | 79.4      | 52.0      | 70.2      |           |           |           |           |
|       | 384  | 729  |                         |               | 77.1          | 87.5          |               |           |           |           | 80.5      | 93.5      | 17.8      | 26.6      |
|       |      |      | SigLIP 2                | 84.1          | 78.7          | 88.1          | 86.0          | 80.4      | 55.8      | 71.7      | 85.7      | 94.9      | 48.4      | 57.5      |
| So/16 | 256  | 256  | mSigLIP [71]            | 80.8          | 74.1 77.8     | 86.1          | 79.5          | 77.1      | 49.4      | 68.6      | 80.0 84.4 | 92.1 94.2 | 50.0      | 62.8 57.5 |
|       | 384  | 576  | SigLIP 2                | 83.4          |               | 87.7 88.1     | 84.8          | 79.7 80.4 | 55.4 56.0 | 71.5      | 85.3      |           | 48.1      |           |
|       |      | 1024 | SigLIP 2                | 84.1          | 78.4          |               | 85.8          |           |           | 71.2 71.3 |           | 95.9      | 48.3      | 57.5      |
|       | 512  |      | SigLIP 2                | 84.3          | 79.1          | 88.1          | 86.2          | 80.5      | 56.0      |           | 85.5      | 95.4      | 48.3      | 57.6      |
| H/14  |      | 256  | MetaCLIP [66]           | 80.5          | 74.1          | -             | 76.5          | -         | 57.5      | -         | 85.0      | -         | -         | -         |
|       | 224  |      | DFN [19]                | 83.4          | 77.3          | -             | 76.5          | -         | 63.1      | -         | 86.5      | -         | -         | -         |
| g/16  | 256  | 256  | SigLIP 2                | 84.5          | 79.2          | 88.3          | 87.1          | 82.1      | 55.7      | 72.5      | 85.3      | 95.3      | 48.2      | 58.2      |
|       |      |      |                         | 85.0          |               |               |               |           |           |           |           |           |           | 57.9      |
|       | 384  | 576  | SigLIP 2                |               | 79.8          | 88.5          | 88.0          | 82.5      | 56.1      | 72.8      | 86.0      | 95.4      | 48.6      |           |
...
|               |       |      | Segmentation ↑   | Segmentation ↑   | Depth ↓   | Depth ↓   | Normals ↓   | Normals ↓   |
|---------------|-------|------|------------------|------------------|-----------|-----------|-------------|-------------|
...
|---------------|-------|---------|----------|---------|---------|----------|----------|
| CLIP [50]     | L/16  |    10.8 |     20.4 |    31.5 |    62   |     96.6 |     81.8 |
| OpenCLIP [27] | G/14  |    13.3 |     21.4 |    36.2 |    61.5 |     97.1 |     81.4 |
| SigLIP [71]   | L/16  |    14   |     23.9 |    37.5 |    61.6 |     96.1 |     81.1 |
| SigLIP 2      | L/16  |    14.3 |     24.1 |    38.8 |    62.4 |     97   |     82.3 |
...
|-------|---------------|-------------|-------------|--------------|
| B/16  | SigLIP        |        42.2 |        33   |         31   |
| B/16  | SigLIP 2      |        42.8 |        34.4 |         32.7 |
| So/14 | SigLIP SigLIP |        44.3 |        39.5 |         40.9 |
| So/14 | 2             |        45.2 |        40.5 |         42.3 |

Cultural Diversity To evaluate for cultural diversity, we report the zero-shot classification accuracy results using Dollar Street [54], GeoDE [51], and Google Landmarks Dataset v2 (GLDv2) [65]. Wealso include 10-shot geolocalization using Dollar Street and GeoDE, as proposed in [49]. For zero-shot evaluation on Dollar Street, we implement the methodology outlined in [54], mapping 96 topics within the dataset to corresponding ImageNet classes. This process results in a subset of 21K images for our analysis.
...
|------|-------------|-----------|-----------|-----------|------------|------------|------------|------------|------------|
| Seq. | Model       | val       | testA     | testB     | val        | testA      | testB      | val-u      | test-u     |
| 256  | SigLIP [71] | 64.05     | 70.10     | 57.89     | 55.77      | 63.57      | 47.51      | 59.06      | 60.33      |
| 256  | SigLIP 2    | 83.76     | 86.21     | 79.57     | 74.26      | 79.85      | 65.83      | 77.25      | 77.83      |
| 576  | SigLIP [71] | 67.17     | 72.94     | 60.94     | 59.09      | 67.26      | 50.22      | 61.98      | 62.64      |
| 576  | SigLIP 2    | 85.18     | 87.92     | 80.53     | 76.08      | 82.17      | 67.10      | 79.08      | 79.60      |
| 256  | Cap [60]    | 60.64     | 65.47     | 56.17     | 52.56      | 58.32      | 45.99      | 56.75      | 57.99      |
| 256  | CapPa [60]  | 64.17     | 69.90     | 58.25     | 56.14      | 63.68      | 48.18      | 58.90      | 59.91      |
| 256  | CLIP [50]   | 65.21     | 71.28     | 58.17     | 57.53      | 66.44      | 47.77      | 59.32      | 60.24      |
| 256  | SigLIP [71] | 67.33     | 72.40     | 61.21     | 59.57      | 67.09      | 51.08      | 61.89      | 62.90      |
| 256  | SigLIP 2    | 86.04     | 89.02     | 81.85     | 77.29      | 83.28      | 70.16      | 80.11      | 80.78      |
| 256  | LocCa [62]  | 88.34     | 91.20     | 85.10     | 79.39      | 85.13      | 72.61      | 81.69      | 82.64      |
| 576  | SigLIP [71] | 70.76     | 76.32     | 63.79     | 63.38      | 71.48      | 54.65      | 64.73      | 65.74      |
| 576  | SigLIP 2    | 87.28     | 90.29     | 82.85     | 79.00      | 85.00      | 70.92      | 81.84      | 82.15      |
| 256  | SigLIP [71] | 64.68     | 71.23     | 58.40     | 57.43      | 66.06      | 49.38      | 59.66      | 60.88      |
| 256  | SigLIP 2    | 86.42     | 89.41     | 82.48     | 77.81      | 84.36      | 70.67      | 80.83      | 81.27      |
| 729  | SigLIP [71] | 67.66     | 74.12     | 62.36     | 60.74      | 69.73      | 52.12      | 62.61      | 63.24      |
| 729  | SigLIP 2    | 87.88     | 91.13     | 83.59     | 80.06      | 86.30      | 72.66      | 82.68      | 83.63      |
| 256  | SigLIP 2    | 87.31     | 90.24     | 83.25     | 79.25      | 85.23      | 71.60      | 81.48      | 82.14      |
...
- [9] M. Caron, H. Touvron, I. Misra, H. Jégou, J. Mairal, P. Bojanowski, and A. Joulin. Emerging properties in self-supervised vision transformers. In CVPR , pages 96509660, 2021.
...
- [18] L. Fan, D. Krishnan, P. Isola, D. Katabi, and Y. Tian. Improving clip training with language rewrites. NeurIPS , pages 3554435575, 2023.
...
- [44] N. Mu, A. Kirillov, D. Wagner, and S. Xie. SLIP: Self-supervision meets languageimage pre-training. In ECCV , pages 529544, 2022.
...
- [53] B. Recht, R. Roelofs, L. Schmidt, and V. Shankar. Do imagenet classifiers generalize to imagenet? In ICML , pages 53895400, 2019.
...
|                   | Large 224/256px   | Large 224/256px   | Large 224/256px   | So400m/14 224px   | So400m/14 224px   | So400m 384px   | So400m 384px   |
|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|----------------|----------------|
...
|      |      |                 | ImageNet-1k   | ImageNet-1k   | ImageNet-1k   | ImageNet-1k   | COCO R@1   | COCO R@1   | TC R@1   | TC R@1   | HT R@1   | HT R@1   | SC R@1   | SC R@1   | S2W R@1   | S2W R@1   |
|------|------|-----------------|---------------|---------------|---------------|---------------|------------|------------|----------|----------|----------|----------|----------|----------|-----------|-----------|
|      | Seq. | Model           | val           | v2            | ReaL          | ObjNet        | T → I      | I → T      | T → I    | I → T    | T → I    | I → T    | T → I    | I → T    | T → I     | I → T     |
|      | 64   | SigLIP 2 (NaF.) | 71.2          | 63.2          | 78.3          | 62.1          | 43.6       | 60.4       | 30.4     | 57.5     | 3.4      | 6.4      | 5.2      | 4.0      | 6.4       | 11.0      |
...
|      |      | SigLIP 2        | 79.1          | 72.5          | 85.4          | 74.5          | 53.2       | 69.7       | 40.5     | 69.4     | 6.1      | 9.8      | 17.1     | 14.2     | 12.9      | 22.9      |
|      | 256  | SigLIP 2 (NaF.) | 78.5          | 71.9          | 84.6          | 74.6          | 51.1       | 67.3       | 39.5     | 69.0     | 7.4      | 12.9     | 19.7     | 17.1     | 14.8      | 26.6      |
| B/16 |      | SigLIP 2        | 80.6          | 73.8          | 86.2          | 77.1          | 54.6       | 71.4       | 43.6     | 73.0     | 7.5      | 12.0     | 23.3     | 19.4     | 14.1      | 24.8      |
...
| B/16 |      | SigLIP 2        | 81.2          | 74.5          | 86.7          | 77.8          | 55.2       | 71.2       | 44.7     | 74.7     | 8.1      | 14.6     | 25.2     | 20.7     | 14.5      | 25.3      |
| B/16 | 1024 | SigLIP 2 (NaF.) | 80.4          | 73.5          | 85.9          | 76.6          | 52.9       | 68.9       | 42.5     | 73.2     | 9.1      | 14.4     | 25.1     | 21.5     | 14.9      | 26.4      |
|      | 64   | SigLIP 2 (NaF.) | 78.5          | 71.0          | 84.2          | 73.8          | 49.6       | 67.4       | 37.0     | 65.5     | 5.6      | 10.3     | 11.8     | 10.9     | 12.1      | 21.4      |
...
|      | 576  | SigLIP 2 (NaF.) | 84.1          | 78.6          | 88.0          | 85.7          | 55.9       | 71.4       | 46.5     | 75.1     | 11.3     | 18.4     | 32.9     | 32.0     | 17.7      | 28.8      |
...
|      |      | SigLIP 2        | 84.3          | 79.1          | 88.1          | 86.2          | 56.0       | 71.3       | 47.3     | 76.0     | 10.3     | 18.3     | 35.9     | 33.5     | 17.9      | 28.1      |
|      | 1024 | SigLIP 2 (NaF.) | 84.4          | 78.8          | 88.1          | 85.8          | 55.8       | 71.0       | 46.9     | 74.9     | 11.7     | 18.4     | 32.6     | 32.4     | 17.8      | 29.4      |
...
|           | 224  | SigLIP   | 13.8          | 12.7            | 27.3           | 50.1          | 48.5     | 92.4     |
|           | 224  | SigLIP 2 | 16.2          | 20.0            | 34.9           | 53.4          | 50.8     | 92.9     |
...
| L/16      |      | SigLIP 2 | 26.8          | 34.5            | 44.4           | 55.2          | 64.5     | 94.9     |
|           | 384  | SigLIP   | 22.8          | 26.0            | 41.7           | 52.9          | 60.5     | 94.3     |
|           | 384  | SigLIP 2 | 30.4          | 39.3            | 48.0           | 55.4          | 66.1     | 95.1     |
...
|           | 224    | SigLIP SigLIP 2   | 31.2 31.0      | 36.6 17.2    |
|           | 256    | SigLIP SigLIP 2   | 30.2 29.7      | 35.6 19.4    |
| B/16      | 384    | SigLIP SigLIP 2   | 30.9 30.6      | 35.8 18.0    |
|           | 512    | SigLIP SigLIP 2   | 31.5 30.8      | 35.4         |
| L/16      | 256    | SigLIP 2          | 32.0 31.1      | 20.0 35.5    |
|           | 384    | SigLIP SigLIP     | 32.0 30.4      | 7.3 34.8     |
|           | 512    | SigLIP 2 SigLIP 2 | 29.2           | 6.6 6.8      |
| So400m/14 | 224    | SigLIP SigLIP 2   | 30.5 29.7      | 33.3 7.4     |
|           | 384    | SigLIP SigLIP 2   | 29.2           | 33.9         |
| So400m/16 | 256    | SigLIP 2 mSigLIP  | 28.1 28.4 31.6 | 7.5 7.2 37.3 |
|           | 384    |                   |                |              |
|           |        | SigLIP 2          | 29.0           | 11.0         |
|           | 512    | SigLIP 2          | 28.2           | 10.8         |
|           |        |                   | 28.1           |              |
| g-opt/16  | 256    | SigLIP 2          |                | 7.9          |
...
Example:
```markdown
![Description based on OCR](../media/doc_1773396664_b840240c_arxiv_2502.14786.pdf) <!-- TODO: Broken image path -->
