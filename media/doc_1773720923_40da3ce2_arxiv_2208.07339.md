...
**File:** doc_1773720923_40da3ce2_arxiv_2208.07339.pdf
**Original:** arxiv_2208.07339.pdf
**Received:** 1773720923
...
- Macháˇ cek, M. and Bojar, O. (2014). Results of the wmt14 metrics shared task. In Proceedings of the Ninth Workshop on Statistical Machine Translation , pages 293-301.
...
| GPT-3 Size                        | Small 768   | Medium 1024   | Large 1536   | XL 2048   | 2.7B 2560   | 6.7B 4096   | 13B 5140   | 175B 12288   |
|-----------------------------------|-------------|---------------|--------------|-----------|-------------|-------------|------------|--------------|
| Model dimension FP16-bit baseline | 1.00x       | 1.00x         | 1.00x        | 1.00x     | 1.00x       | 1.00x       | 1.00x      | 1.00x        |
...
We test Int8 training on a variety of training settings and compare to 32-bit baselines. We test separate settings for running the transformer with 8-bit feed-forward networks with and without 8-bit linear projections in the attention layer, as well at the attention iteself in 8-bit and compare against 32-bit performance. We test two tasks (1) language modeling on part of the RoBERTa corpus including Books (Zhu et al., 2015), CC-News (Nagel, 2016), OpenWebText (Gokaslan and Cohen, 2019), and CC-Stories (Trinh and Le, 2018); and (2) neural machine translation (NMT) (Ott et al., 2018) on WMT14+WMT16 (Macháˇ cek and Bojar, 2014; Sennrich et al., 2016).
...
| 209M 209M 209M | glyph[check] glyph[check]              | glyph[check] .                         |                                        | 0% 0% 0%  | 16.74 16.77 16.83 |
| 209M 209M 209M | glyph[check] glyph[check] glyph[check] | glyph[check] glyph[check] glyph[check] |                                        | 2% 5% 10% | 16.78 16.77 16.80 |
| 209M 209M 209M | glyph[check] glyph[check]              | glyph[check] glyph[check] glyph[check] | glyph[check] glyph[check] glyph[check] | 2% 5% 10% | 24.33 20.00       |
| 1.1B 1.1B 1.1B | glyph[check] glyph[check]              | glyph[check]                           |                                        | 0% 0%     | 19.00             |
|                | glyph[check]                           |                                        |                                        |           |                   |
|                |                                        |                                        |                                        |           | 9.99 9.93         |
|                |                                        |                                        |                                        | 0%        | 10.52             |
| 1.1B           | glyph[check]                           |                                        |                                        |           |                   |
...
| Is 8-bit                                                         | Is 8-bit                                            | Decomp BLEU        |                                   |
|------------------------------------------------------------------|-----------------------------------------------------|--------------------|-----------------------------------|
| FFN                                                              | Linear                                              | Decomp BLEU        |                                   |
| glyph[check] glyph[check] glyph[check] glyph[check] glyph[check] | glyph[check] glyph[check] glyph[check] glyph[check] | 0% 0% 0% 2% 5% 10% | 28.9 28.8 unstable 28.0 27.6 27.5 |
...
| glyph[check] |              | 0%     | 90.2 | 94.7 | 92.3 | 85.4 | 96.4  | 91.0 | 68.6 | 91.9  | 88.8 |
| glyph[check] | glyph[check] | 0%     | 90.2 | 94.4 | 92.2 | 84.1 | 96.2  | 89.7 | 63.6 | 91.6  | 87.7 |
| glyph[check] | glyph[check] | 1%     | 90.0 | 94.6 | 92.2 | 83.0 | 96.2  | 89.7 | 65.8 | 91.8  | 87.9 |
| glyph[check] | glyph[check] | 2%     | 90.0 | 94.5 | 92.2 | 85.9 | 96.7  | 90.4 | 68.0 | 91.9  | 88.7 |
| glyph[check] | glyph[check] | 3%     | 90.0 | 94.6 | 92.2 | 86.3 | 96.4  | 90.2 | 68.3 | 91.8  | 88.7 |
...
Example:
```markdown
![Description based on OCR](../media/doc_1773720923_40da3ce2_arxiv_2208.07339.pdf) <!-- TODO: Broken image path -->
