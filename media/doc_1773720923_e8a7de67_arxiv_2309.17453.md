...
**File:** doc_1773720923_e8a7de67_arxiv_2309.17453.pdf
**Original:** arxiv_2309.17453.pdf
**Received:** 1773720923
...
| Model Dense Attention   | Llama-2-7B-Chat Window Attention   | Llama-2-7B-Chat Window Attention   | Llama-2-13B-Chat w/ Re-computation   | Llama-2-13B-Chat w/ Re-computation   | Llama-2-70B-Chat StreamingLLM   | Llama-2-70B-Chat StreamingLLM   |
|-------------------------|------------------------------------|------------------------------------|--------------------------------------|--------------------------------------|---------------------------------|---------------------------------|
| Dataset                 | Arc-E                              | Arc-C                              | Arc-E                                | Arc-C                                | Arc-E                           | Arc-C                           |
| One-shot                | 71.25                              | 53.16                              | 78.16                                | 63.31                                | 91.29                           | 78.50                           |
| Dense Window            | 3.58                               | 1.39                               | 0.25                                 | OOM 0.34                             | 0.12                            | 0.32                            |
...
- Tomáš Koˇ ciský, Jonathan Schwarz, Phil Blunsom, Chris Dyer, Karl Moritz Hermann, Gábor Melis, and Edward Grefenstette. The narrativeqa reading comprehension challenge, 2017.
...
- Zhenyu Zhang, Ying Sheng, Tianyi Zhou, Tianlong Chen, Lianmin Zheng, Ruisi Cai, Zhao Song, Yuandong Tian, Christopher Ré, Clark Barrett, Zhangyang Wang, and Beidi Chen. H 2 o: Heavyhitter oracle for efficient generative inference of large language models, 2023b.
...
| Llama-2-7B-32K-Instruct   | Llama-2-7B-32K-Instruct   | Cache Config   | Cache Config   | Cache Config   | Cache Config   |
|---------------------------|---------------------------|----------------|----------------|----------------|----------------|
...
| Llama2-7B-chat         | Single-Document QA   | Single-Document QA   | Multi-Document QA   | Multi-Document QA   | Summarization   | Summarization   |
|------------------------|----------------------|----------------------|---------------------|---------------------|-----------------|-----------------|
...
Liama-2-/7B Attention Score on the First Token in Eacn Layer (SeqlLen = 4096)
...
Example:
```markdown
![Description based on OCR](../media/doc_1773720923_e8a7de67_arxiv_2309.17453.pdf) <!-- TODO: Broken image path -->
