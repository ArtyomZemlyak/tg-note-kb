...
![Таблица проблем в AlphaResearchComp](../../../media/img_1763352310_aqadhxjrg6oayeh_from_cache_false_document_key_1aeea31f19.jpg) <!-- TODO: Broken image path -->

**Описание:** Таблица 3: Обзор проблем в AlphaResearchComp. Подробные определения, базовые значения и ссылки для каждой проблемы приведены в Приложении D.
