...
[[ai/agents/code_agents/happy_local_agent.md]] - реализация локального агента с автоматической инъекцией контекста, расширяющего возможности Claude Code
...
[[ai/tools/claude_code.md]] - веб-интерфейс для программирования от Anthropic, реализующий подход к скиллам в контексте разработки ПО
[[ai/tools/happy_coder.md]] - мобильное и веб-приложение, расширяющее возможности Claude Code с автоматической инъекцией контекста