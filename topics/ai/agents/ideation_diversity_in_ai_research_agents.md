...
![Пример потока работы ИИ-исследовательского агента при выполнении задачи MLE-bench](../../../media/img_1764121586_aqadrwxrg8jlmul_figure2_an_example_flow_of_an.jpg) <!-- TODO: Broken image path -->
...
![Разнообразие ML подходов/архитектур в AIDE и AIRA-Greedy](../../../media/img_1764121586_aqadsaxrg8jlmul_a_diversity_of_ml_approaches_architectur.jpg) <!-- TODO: Broken image path -->
...
![Образец изображения, иллюстрирующего разнообразие идей](../../../media/img_1764121586_aqadrgxrg8jlmul_image.jpg) <!-- TODO: Broken image path -->
...
3. [AlphaXiv paper link](https://www.alphaxiv.org/abs/2511.15593) - альтернативный доступ к статье через AlphaXiv