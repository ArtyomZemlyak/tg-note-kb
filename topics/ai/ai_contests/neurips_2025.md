...
![NeurIPS 2025 Best Paper Awards](../../../media/img_1764342436_aqad1atrg5qtqel_image_image.jpg)
...
**Исследование конвергенции ответов LLM:** Анализ того, как разные LLM начинают давать схожие ответы, что может свидетельствовать о потере разнообразия.

**Новый датасет:** Infinity-Chat — создан для изучения эффекта hivemind и потери разнообразия в ответах LLM.
