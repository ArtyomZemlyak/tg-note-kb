...
Одной из ключевых статей конференции стала работа "Perception Encoder: The best visual embeddings are not at the output of the network", в которой исследователи от Meta AI представили новую модель, где лучшие визуальные эмбеддинги извлекаются не из последнего, а из промежуточных слоёв трансформера.
