...
### Эмерджентный мисэлаймент
- Риск возникновения не выровненного поведения как непреднамеренного побочного эффекта процессов обучения, как показано в исследовании Anthropic о мисэлайменте из-за взлома системы вознаграждения ([reward_hacking_emergent_misalignment.md](reward_hacking_emergent_misalignment.md) <!-- TODO: Broken link -->)
...
- [[llm_brain_rot.md]] - Когнитивная деградация LLM, включая ухудшение следования этическим нормам при обучении на низкокачественных данных
- [[data_quality_impact_assessment.md]] - Исследование влияния качества данных на деградацию этического поведения LLM
- [[self_proposed_rubrics.md]] - Метод для выравнивания в субъективных задачах
- [[architectures/gpt_oss_safeguard.md]] - Специализированные модели для задач безопасности и модерации контента
