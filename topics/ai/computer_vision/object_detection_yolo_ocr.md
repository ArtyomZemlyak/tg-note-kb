...
- [[ai/tools/deepseek_ocr.md]] - Современное решение OCR от DeepSeek с высокой эффективностью обработки документов
- [[../tools/lightonocr.md]] - Современная OCR-модель от LightOnAI, дистиллированная из Qwen2-VL-72B-Instruct, обеспечивающая высокое качество и скорость при низкой стоимости
- [[../tools/docling.md]] - Библиотека обработки документов от IBM, сочетающая возможности OCR и структурного анализа документов
