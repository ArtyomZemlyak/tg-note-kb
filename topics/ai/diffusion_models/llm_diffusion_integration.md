...
Новейшая технология от Minimax, представленная в [[../../computer_vision/diffusion_models/minimax_vtp_visual_tokenizer.md]] - VTP (Visual Tokenizer Pre-training), которая ставит под сомнение традиционное убеждение, что масштабирование Stage 1 (VAE) в диффузионных моделях не приносит пользы. VTP объединяет лосс реконструкции пикселей, самообучение и контрастное обучение изображение-текст для создания семантически структурированного латентного пространства.
