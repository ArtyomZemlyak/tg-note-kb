...
- [[architectures/text_diffusion_models.md]] - Подробное описание текстовых диффузионных моделей
...
- [[architectures/planned_diffusion.md]] - Гибридный метод, сочетающий диффузию и авторегрессивные подходы
...
### ControlNet и условная генерация
ControlNet представляет собой мощную архитектуру для точного управления диффузионными моделями с использованием дополнительных визуальных условий. Это позволяет контролировать генерацию изображений с помощью:
- Карт краев (Canny, HED)
- Карт глубины
- Поз человека
- Геометрических структур (MLSD)
- Эскизов и других условий

ControlNet особенно важен для интеграции в современные диффузионные модели, такие как Z-Image Turbo, обеспечивая точный контроль над структурой и содержанием генерируемых изображений.
...
## Современные разработки диффузионных моделей

### Minimax VTP (Visual Tokenizer Pre-training)
Новейшая технология от Minimax, представленная в [[computer_vision/minimax_vtp_visual_tokenizer.md]] - VTP (Visual Tokenizer Pre-training), которая ставит под сомнение традиционное убеждение, что масштабирование Stage 1 (VAE) в диффузионных моделях не приносит пользы. VTP объединяет лосс реконструкции пикселей, самообучение и контрастное обучение изображение-текст для создания семантически структурированного латентного пространства.

### Seedream v4.5

Seedream v4.5 от ByteDance представляет собой передовое развитие диффузионных моделей в области генерации изображений. Модель объединяет возможности генерации и редактирования изображений в единой архитектуре и включает несколько ключевых улучшений:

- **Сохранение материалов и деталей**: Модель лучше сохраняет мелкие детали и текстуры при извлечении объектов или смешивании нескольких изображений
- **Интеллектуальная типографика и дизайн**: Улучшено качество текстов, упаковок, плакатов, диаграмм и других визуальных элементов
- **Реалистичная генерация персонажей**: Качество портретов значительно улучшено, черты лица остаются четкими
- **Когерентность при многократной ссылке**: Поддерживает до 10 изображений на входе и дает структурно согласованный результат

### Сравнение с другими моделями

Seedream v4.5 демонстрирует отличные результаты по сравнению с другими текст-в-изображение моделями, особенно в области типографики и обработки текста в дизайне. Модель оптимизирована для генерации материалов с встроенным текстом, постеров и бренд-активов.

Для подробного анализа Seedream v4.5 см. [[../computer_vision/image_generation/seedream_v4_5.md]].

## Заключение

Диффузионные модели для текста и изображений продолжают активно развиваться, обеспечивая новые возможности для генерации и редактирования контента. Новые разработки, такие как Seedream v4.5, демонстрируют тенденции к объединению различных задач (генерация и редактирование) в единой архитектуре, а также улучшению качества текста и детализации. Несмотря на существующие вызовы, особенно в области скорости генерации, потенциал этих моделей для создания разнообразного и высококачественного контента делает их важным направлением исследований.
...
- [[computer_vision/autoencoder_diffusability_improvement.md]] - Улучшение диффузабельности автоэнкодеров для более эффективного обучения диффузионных моделей