...
- [[../../ai/diffusion_models/computer_vision/diffusion_pixel_space.md|Диффузионные модели в пиксельном пространстве]] - сравнение различных подходов к предсказанию (x0, ε, v) в контексте обучения на подпространствах
- [[../implicit_dynamical_regularization.md|Неявная динамическая регуляризация]] - объяснение обобщающих свойств диффузионных моделей через динамику обучения
- [[../diffusion_models/memorization_vs_generalization.md|Меморизация против обобщения]] - современные открытия о временных шкалах в обучении диффузионных моделей