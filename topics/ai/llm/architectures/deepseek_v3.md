...
- [[../tools/lplb_linear_programming_load_balancer.md]] - Инновационный балансировщик нагрузки от DeepSeek для MoE моделей, использующий линейное программирование
- [[../models/deepseek_v3_2_exp.md|DeepSeek V3.2-Exp]] - Экспериментальная модель с улучшенным механизмом разреженного внимания
- [[../models/deepseek_v3_2_speciale.md|DeepSeek V3.2-Speciale]] - Флагманская модель с архитектурой V3.1 Terminus и технологией DSA