...
- Использует более сложный механизм "удивления" на основе градиента с моментом, в отличие от простых дельта-обновлений в DeltaNet
- Применяет глубокую нелинейную структуру (MLP), а не линейные обновления
- Включает адаптивный механизм забывания с зависящим от данных гейтом

### Сравнение с TTT (Test-Time Training)
- Более целенаправленная архитектура с метамоделью, в отличие от универсального подхода TTT
- Использует специфическую функцию потерь ассоциативной памяти для определения "удивления"
- Включает механизм момента для сохранения "памяти об удивлении", а не простого обновления параметров
...
![Производительность LMM и базовых моделей на задачах языкового моделирования и рассуждений](../../../../images/img_1763025480_AgACAgIA.jpg) <!-- TODO: Broken image path -->

Производительность LMM и базовых моделей на задачах языкового моделирования и рассуждений

![Абляционное исследование компонентов LMM](../../../../images/img_1763025480_AgACAgIA.jpg) <!-- TODO: Broken image path -->

Абляционное исследование компонентов LMM
