...
- **Mamba-2**: Интеграция с матричными ускорителями через "SSD" дуальность (State Space Duality)
- **Mamba-3**: Введение трапецеидальной дискретизации, MIMO-формулировки и комплексной динамики через RoPE - [[mamba_3_architecture.md]]
- Повышенная эффективность инференса и способность к отслеживанию состояния
