...
Как показало исследование LinkedIn на EMNLP 2025, дистилляция и прунинг могут выполняться достаточно агрессивно, а редистилляция служит балансирующим шагом: компактная модель остаётся быстрой и дешёвой, но при этом уверенно держит качество. 
