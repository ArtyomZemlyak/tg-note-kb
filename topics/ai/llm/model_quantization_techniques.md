...
- Современный метод квантования-ориентированного обучения (QAT)
- Использует кривизна-ориентированную оценку градиентов для точной квантования
- Основан на подходе с множителями Лагранжа для задач оптимизации с ограничениями
- Позволяет эффективно обучать модели с низкой точностью (включая MXFP4)
- Показывает улучшенные результаты по сравнению с методом QuEST
- Имеет теоретически обоснованный подход через error feedback механизм
...
- [CAGE: CURVATURE-AWARE GRADIENT ESTIMATION FOR ACCURATE QUANTIZATION-AWARE TRAINING](https://arxiv.org/abs/2510.18784) - статья о методе CAGE
- [QuEST: Stable Training of LLMs with 1-Bit Weights and Activations](https://arxiv.org/abs/2502.05003) - статья о методе QuEST