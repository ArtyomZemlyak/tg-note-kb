...
- [[../reinforcement_learning/laser_reinforcement_learning.md]] - метод оптимизации LLM с использованием самонаграждения последнего токена
- [[../../tools/claude_code.md]] - веб-интерфейс для программирования, использующий Claude Haiku 4.5 и другие модели Anthropic