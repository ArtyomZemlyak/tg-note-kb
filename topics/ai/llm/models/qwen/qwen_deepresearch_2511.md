...
Qwen DeepResearch и DR TULU (Deep Research Tulu) представляют собой два разных подхода к задачам глубоких исследований:

- **Qwen DeepResearch 2511** - коммерческая система от Alibaba, встроенная в чат-бот Qwen, с фокусом на удобство использования и интеграцию с продуктами Alibaba Cloud
- **DR TULU** - открытая исследовательская система от Allen Institute, использующая инновационный метод RLER (Reinforcement Learning with Evolving Rubrics) и библиотеку dr-agent-lib

Оба подхода стремятся к созданию агентов, способных выполнять задачи глубоких исследований, но используют разные архитектуры обучения и интеграции инструментов.
