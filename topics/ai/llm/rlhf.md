...
- Техника пост-тренировки для генеративных рекомендательных моделей, "упрощённая альтернатива RLHF", разработанная Netflix
- Использует дообучение с учётом преимущества (advantage) - насколько текущее предсказание лучше среднего по reward-модели
- Реализует reward-learning без использования полноценного RLHF
- [[../../ai/recsys/advantage_weighted_sft.md|Advantage-Weighted Supervised Fine-Tuning - подробное описание]]
...
### Бинарное обучение с подкреплением для снижения галлюцинаций (Binary RAR)
- Использование бинарного вознаграждения (0 или 1) на основе проверки фактологичности с внешними источниками
- Эффективное снижение галлюцинаций при сохранении полезности модели
- [[../reinforcement_learning/binary_rar.md|Binary RAR - подробное описание]]
