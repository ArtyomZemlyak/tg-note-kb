...
- **RoPE в латентах**: Использование механизма Rotational Positional Embedding в сжатом латентном пространстве для сохранения позиционной информации
- **Дополнительная оптимизация**: В новых версиях (например, DeepSeek-V3.2) MLA усиливается за счет интеграции с DSA с top-K селектором в латентах
...
- [[dsa_with_top_k_selector.md]] - DSA с top-K селектором, интегрированный с MLA в DeepSeek-V3.2
