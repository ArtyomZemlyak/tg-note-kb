...
![Архитектура фреймворка Miles](../../../../media/img_1763889724_aqaddw1rg0seeel_radixark_miles.jpg) <!-- TODO: Broken image path -->
...
![Концептуальная схема Miles](../../../../media/img_1763889724_aqadea1rg0seeel_image.jpg) <!-- TODO: Broken image path -->
...
Miles развивает идеи, заложенные в его предшественнике - SLiME (Structured Language Model Editor), который доказал эффективность легковесного дизайна в современных пайплайнах пост-тренировки. SLiME использовался, в частности, для запуска GLM-4.6, что демонстрирует его практическую применимость. Miles же масштабирует эти концепции для enterprise-уровня и специализируется на обучении MoE моделей, что стало основой для разработки серий моделей с нативными возможностями вызова инструментов, таких как GLM-4.6V.
