...
### Mamba-3
- Дальнейшее развитие архитектуры Mamba с улучшенными возможностями
- Введение трапецеидальной дискретизации, MIMO-формулировки и комплексной динамики через RoPE
- Улучшенная способность к отслеживанию состояния и эффективность инференса - [[mamba_3_architecture.md]]

### Vision Mamba
- Адаптация Mamba для задач компьютерного зрения - [[vision_mamba.md]]
- Использование скользящих окон и пространственной иерархии
- Эффективная обработка изображений с линейной сложностью

### Audio Mamba
- Адаптация Mamba для обработки аудио-сигналов - [[audio_mamba.md]]
...
5. [State Space Models for Modern Sequence Modeling](https://www.cs.cmu.edu/~./epxing/Class/10709/handouts/SSM_survey.pdf) - обзор State Space Models в контексте современного машинного обучения# Архитектура Mamba: Подробное описание
