...
Иллюстрация процесса параллельного обучения нейронной памяти и производительности TTT и других архитектур на задачах языкового моделирования и рассуждений
...
- [[../../computer_vision/test_time_training_in_vision_models.md]] - Применение TTT в визуальных моделях, включая задачи рассуждения как в VARC
...
5. [ARC Is a Vision Problem!](https://arxiv.org/abs/2511.14761) - Применение TTT в визуальных моделях для задач ARC (VARC)