...
Механистическая интерпретируемость тесно связана с [гипотезой линейности](../../research_and_methodology/theory/linearity_hypothesis.md) <!-- TODO: Broken link -->, поскольку линейные представления облегчают анализ внутренних состояний модели. Понимание того, как концепты представлены как направления в пространстве активаций, позволяет более точно картировать вычислительные схемы.
