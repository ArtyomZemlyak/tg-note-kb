...
- [[models/drax.md]] - Современная нон-автогрессивная модель ASR с использованием дискретного флоу-мэтчинга
- [[models/discrete_flow_matching_asr.md]] - Подробное описание подхода дискретного флоу-мэтчинга в задачах ASR