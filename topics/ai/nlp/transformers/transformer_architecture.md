...
- **Диффузионные трансформеры**: Модели, использующие принципы диффузии с архитектурой трансформера для генерации, например, через многократное маскирование и восстановление (см. [[../../llm/diffusion_models.md]] - общее описание диффузионных моделей, [[../../computer_vision/diffusion_transformer.md]] - DiT (Diffusion Transformer) для генерации изображений, и [[../../llm/architectures/diffusion/text_diffusion_models.md]] - альтернативный подход к генерации текста с использованием encoder-only архитектуры)
