...
- **Диффузионные архитектуры**: Используют принципы диффузии с архитектурой трансформера для генерации текста, например, через многократное маскирование и восстановление (см. [[../../llm/architectures/diffusion/text_diffusion_models.md]] - альтернативный подход к генерации текста с использованием encoder-only архитектуры).
