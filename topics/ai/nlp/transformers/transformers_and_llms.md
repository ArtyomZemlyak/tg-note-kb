...
- **Диффузионные архитектуры**: Используют принципы диффузии с архитектурой трансформера для генерации текста, например, через многократное маскирование и восстановление (см. [[../../llm/diffusion_models.md]] - общее описание диффузионных моделей и [[../../llm/architectures/diffusion/text_diffusion_models.md]] - альтернативный подход к генерации текста с использованием encoder-only архитектуры).
