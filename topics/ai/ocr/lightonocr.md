...
- [[chandra_ocr.md]] - Современная OCR-модель от DataLab, конкурирующая по качеству с LightOnOCR-1B, но с большей поддержкой языков
- [[hunyuanocr.md]] - Компактная OCR-модель от Tencent с 1 миллиардом параметров, достигающая SOTA результатов, конкурент LightOnOCR по эффективности
