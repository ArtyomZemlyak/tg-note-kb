...
- [[optimizer_quantization_relationship.md]] - Исследование показывает, что Muon имеет наименьший MMR среди оптимизаторов и наилучшее качество без квантования, но не самое лучшее при квантовании
