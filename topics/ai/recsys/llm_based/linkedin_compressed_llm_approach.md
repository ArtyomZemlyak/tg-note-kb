...
LinkedIn представила практический опыт перехода от больших LLM к более компактным Small Language Models (SLM) в рекомендательных системах на конференции EMNLP 2025. Подход позволяет эффективно использовать сжатые модели в реальных рекомендательных сервисах с высоким трафиком, решая проблемы высокой стоимости инференса и больших задержек, характерных для больших LLM. Важно отметить, что этот подход отличается от традиционных рекомендательных систем, которые уже показали отличные результаты в задачах рекомендаций, но их применение в продакшене часто упирается в два жёстких ограничения: высокую стоимость инференса и большие задержки при обслуживании трафика.
...
Авторы подчеркивают не только сам метод сжатия, но и практические инженерные аспекты:
- оптимизацию инференса;
- особенности деплоя;
- дизайн экспериментов в продакшене.

Эти детали делают работу особенно полезной для команд, которые разворачивают ML-модели в реальных продуктах, а не только в исследовательских прототипах.

Качественные рекомендательные системы не обязаны опираться на огромные LLM.
Грамотно дистиллированные и сжатые SLM:
- дают сопоставимое качество;
- работают в разы быстрее;
- существенно снижают стоимость инференса.

Для крупных платформ, таких как LinkedIn, это критичный фактор — и хороший ориентир для всех, кто думает о масштабируемых ML-решениях в рекомендациях.
...
3. [Обсуждение подхода LinkedIn к сжатию LLM от AI VK](https://t.me/langotime) - Дополнительный обзор с подробностями о практическом применении и результатах