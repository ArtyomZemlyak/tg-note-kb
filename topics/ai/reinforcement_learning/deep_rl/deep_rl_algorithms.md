...
## Современные подходы к глубокому RL

### Contrastive Reinforcement Learning (CRL)

CRL переформулирует задачу goal-conditioned RL как задачу обучения представлений (representation learning) через бинарную классификацию, в отличие от традиционной регрессии значений. Вместо регрессии Q-значения Q(s,a) для минимизации ошибки Беллмана, CRL обучает эмбеддинги текущих пар состояние-действие ϕ(s,a) и целей ψ(g) максимизировать сходство для "положительных" пар (где g реально встретилась в будущем траектории) и минимизировать для "отрицательных" (случайные цели).
...
**Преимущества:**
- Более робастные градиенты по сравнению с скалярной регрессией
- Возможность масштабирования до экстремальной глубины
- Самообучение без необходимости ручной разметки наград
- Лучшее понимание топологии пространства задач

### Асинхронное масштабирование глубины

Недавние исследования (например, "1000 Layer Networks for Self-Supervised RL" - Wang et al.) показали, что комбинация CRL с современной архитектурной "начинкой" (резидуальные связи, LayerNorm, Swish активации) позволяет масштабировать сети от традиционных 2-5 слоёв до 1000+ слоёв, при этом качество растёт монотонно с глубиной.

**Ключевые архитектурные элементы:**
- Residual Blocks: h_{i+1} = h_i + F_i(h_i), где F_i = Dense → LayerNorm → Swish
- Контрастное обучение вместо регрессии
- Self-supervised learning формализм

**Преимущества глубокого масштабирования:**
- Эмерджентные навыки локомоции без сложного инжиниринга наград
- Улучшенное топологическое понимание (геодезическое vs евклидово расстояние)
- Прирост в 20-50 раз по сравнению с традиционными методами
...
| CRL | Contrastive | Любой | Очень высокая | Высокая при правильной архитектуре | Масштабируется до 1000+ слоёв |
...
- Проблема "мелководья" - ограничение глубины сетей в традиционных RL подходах
...
### Ограничения глубины
- Традиционные RL алгоритмы (SAC, TD3) деградируют или выходят на плато при увеличении глубины
- Затухание градиентов в глубоких сетях
- Нестабильность при обучения на редких сигналах обратной связи
...
- [[./deep_scaling_contrastive_rl.md|Глубокий RL с контрастным обучением]] - масштабирование до 1000 слоёв с использованием self-supervised и контрастных методов
...
- [[../../ai_contests/neurips_2025.md]] - Награды NeurIPS 2025, включающие достижения в Self-Supervised RL для обучения экстремально глубоких сетей (1024 слоя)
- [[./deep_scaling_contrastive_rl.md]] - Глубокий RL с контрастным обучением, масштабирование до 1000+ слоёв
