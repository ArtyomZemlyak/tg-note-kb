...
[[../llm/models/anthropic_haiku_4_5.md]] - сравнение методов оптимизации LLM
[[compute_as_teacher.md]] - Альтернативный метод самонаграждения
[[self_proposed_rubrics.md]] - Другой подход к самонаграждению в непроверяемых задачах
[[reference_free_learning.md]] - Обучение без эталонов, контекст обоих методов
[[../llm/reasoning/rlvr_reasoning_limitations.md]] - Исследование ограничений RLVR методов, включая LASER, в расширении способностей к рассуждению за пределы базовой модели