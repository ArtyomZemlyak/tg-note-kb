...
### V-JEPA
V-JEPA (Video JEPA) - видео-архитектура, расширяющая подход JEPA на временные последовательности.

### VL-JEPA
VL-JEPA (Vision-Language JEPA) - визуально-языковая модель, использующая архитектуру JEPA для предсказания непрерывных текстовых эмбеддингов вместо дискретных токенов, развязывая семантическое рассуждение и синтаксическую генерацию.
...
- [[computer_vision/vl_jepa_model.md]] - VL-JEPA как мультимодальная архитектура, использующая подходы JEPA для визуально-языковых задач
- [[computer_vision/v_jepa.md]] - V-JEPA как развитие подхода JEPA для видеоанализа
- [[computer_vision/world_models.md]] - World модели, контекст применения JEPA архитектур
