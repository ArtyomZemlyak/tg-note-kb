...
В контрастивных методах (как в SimCLR, MoCo) модель учится отображать похожие примеры близко друг к другу в пространстве представлений, а непохожие - далеко.
