...
![SIGReg Algorithm with Epps-Pulley statistic](../../../images/img_1763179087_AgACAgIA.jpg) <!-- TODO: Broken image path -->

**Описание:** Алгоритм 1. SIGReg с использованием статистики Эппса-Палли с поддержкой DDP и O(N) сложностью по времени и памяти. x - это тензор (M, K), num_slices - это A в определении 2, "global_step" используется для синхронизации выборки на разных GPU и может быть опущен для обучения на одном GPU. Оптимизированная реализация с кэшированием также предоставлена в официальной кодовой базе, временные характеристики вычислений приведены в таблице 6.
