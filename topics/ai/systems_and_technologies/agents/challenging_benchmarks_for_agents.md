...
|----------|-----------|----------------|-----------|
| Vending-Bench 2 | Бизнес-автоматизация | Долгосрочная стабильность, управление ресурсами, устойчивость к обману | Очень высокая |
...
- [[ai/agents/vending_bench_2_long_term_business_automation_benchmark.md]] - Бенчмарк, оценивающий долгосрочную стабильность агентов в симуляции бизнеса
