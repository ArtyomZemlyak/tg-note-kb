...
![Реакции на запрос "Напишите метафору о времени" кластеризованные с помощью PCA для уменьшения размерности эмбеддингов предложений до двух измерений](../../../../../media/img_1764342532_aqadhxjrgr9qul_figure_1_responses_to_the_query.jpg) <!-- TODO: Broken image path -->
...
![Средние попарные сходства эмбеддингов предложений между ответами от разных моделей раскрывают substantial семантическое перекрытие в выходах моделей](../../../../../media/img_1764342532_aqadhhjrgr9qul_figure_6_average_pairwise_sentence_embed.jpg) <!-- TODO: Broken image path -->
