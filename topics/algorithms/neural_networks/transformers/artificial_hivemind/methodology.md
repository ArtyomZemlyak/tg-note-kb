...
![Тепловая карта показывает степень повторения в ответах на открытые запросы, сгенерированные одной и той же LLM](../../../../../media/img_1764342532_aqadirjrgr9qul_figure_4_the_heatmap_shows_degree.jpg) <!-- TODO: Broken image path -->
...
![Тепловая карта показывает степень повторения в ответах на открытые запросы, сгенерированные одной и той же LLM при использовании min-p семплирования с параметрами (top-p = 1.0, min-p = 0.1, температура = 2.0)](../../../../../media/img_1764342532_aqadihjrgr9qul9_figure_5_the_heatmap_shows_degree.jpg) <!-- TODO: Broken image path -->
...
![Среднее количество уникальных исходных моделей среди топ-N наиболее схожих ответов на каждый открытый запрос на 25 LLM](../../../../../media/img_1764342532_aqadibjrgr9qul9_figure_8_the_avg_of_unique.jpg) <!-- TODO: Broken image path -->
...
![Гистограмма слева показывает распределение энтропии Шеннона, вычисленной по 25 человеческим оценкам для каждой пары (Запрос, Ответ)](../../../../../media/img_1764342532_aqadjbjrgr9qul_figure_9_the_left_histogram_shows.jpg) <!-- TODO: Broken image path -->
