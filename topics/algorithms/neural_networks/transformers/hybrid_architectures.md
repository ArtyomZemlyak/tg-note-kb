...
### OLMo Hybrid
- **Особенность**: Гибридная архитектура от Allen Institute for AI (AI2), комбинирующая Gated DeltaNet и Full Attention
- **Структура**: Соотношение 3:1 (75% Gated DeltaNet, 25% Full Attention)
- **Преимущества**: 2x эффективность данных относительно OLMo 3 при сохранении показателей MMLU
- **Применение**: Эффективное обучение с сокращёнными требованиями к данным

### Nemotron Elastic
- **Состав**: Гибридная архитектура с Mamba и Attention, объединенная в рамках эластичного фреймворка
- **Структура**: Внутри одной модели (12B) содержатся вложенные подсети (6B, 9B) с возможностью динамической маршрутизации
- **Преимущества**: Эффективное обучение семейства моделей в одном процессе с сохранением способностей к рассуждению
- **Применение**: Рассуждающие LLM с возможностью масштабирования под разные вычислительные ограничения
