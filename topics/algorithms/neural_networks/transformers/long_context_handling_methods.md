...
- **RoPE**: Вращательные позиционные эмбеддинги, позволяющие моделям лучше обобщаться на более длинные последовательные
...
- **RoPE++**: Дальнейшее развитие RoPE, которое возвращает "потерянную" мнимую часть комплексного числа в вычисление внимания, разделяя головы на "реальные" (для локальных зависимостей) и "мнимые" (для глобальных зависимостей). Подробнее см. [[rope_plus_plus_ropepp_imaginary_extension.md]]
