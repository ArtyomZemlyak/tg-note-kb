...
[[../../../ai/interpretability/representation_geometry/index.md]] — Геометрия представлений в языковых моделях: направление геометрической интерпретируемости, изучающее пространственные структуры (циклические многообразия, кривые Лиссажу) в активациях LLM
[[../../../ai/interpretability/representation_geometry/symmetry_in_language_statistics.md]] — Симметрия в языковой статистике: фундаментальная теория, объясняющая происхождение геометрических структур через трансляционную симметрию в ко-оккурентности слов
