...
- [[engram_conditional_memory_system.md]] - Альтернативный подход к разреженности через масштабируемые lookup-таблицы, предлагающий новую ось разреженности в дополнение к вычислительной разреженности MoSA
- [[engram_technical_concepts.md]] - Глубокий анализ архитектурных инноваций Engram, включая формализацию trade-off между MoE и lookup-базированными подходами