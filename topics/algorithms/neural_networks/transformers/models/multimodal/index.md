...
- [[glm_46v|GLM-4.6V]] - Последняя серия мультимодальных моделей от Zhipu AI с нативными возможностями вызова функций
- [[intern_s1_pro.md|Intern-S1-Pro]] - Триллионная MoE мультимодальная модель для научных задач (AI4Science)