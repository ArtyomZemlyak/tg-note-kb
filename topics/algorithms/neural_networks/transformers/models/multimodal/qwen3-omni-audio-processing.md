...
Кроме встроенных возможностей аудиообработки в Qwen3-Omni, компания Alibaba также выпустила выделенные модели распознавания речи [[../../../../../applications/audio_processing/speech/asr/qwen3_asr/qwen3_asr_model.md|Qwen3-ASR]], включающие Qwen3-ASR-1.7B и Qwen3-ASR-0.6B, а также [[../../../../../applications/audio_processing/speech/asr/qwen3_asr/qwen3_forcedaligner.md|Qwen3-ForcedAligner-0.6B]] для точного сопоставления текста и аудио.
