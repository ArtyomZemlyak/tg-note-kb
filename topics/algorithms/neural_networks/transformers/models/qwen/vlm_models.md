...
- **Типографическая слепота (Typography blindness)**: Современные VLM идеально читают текст, но не воспринимают его визуальное оформление (шрифт, размер, стиль). См. [[../../../../ai/vision_language_models/typography_gap_in_vlm.md|Typography Gap in VLM]] — систематическое исследование этой проблемы с использованием бенчмарка FontBench.
