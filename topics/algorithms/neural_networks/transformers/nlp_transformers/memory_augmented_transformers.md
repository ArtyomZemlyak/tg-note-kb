...
Недавним развитием в этой области являются архитектуры Titans, которые включают модуль долгосрочной памяти (LMM), обучаемый адаптивно запоминать и забывать информацию, оптимизируя собственные параметры прямо во время инференса. В отличие от традиционных MAT, LMM функционирует как метамодель, способная к самообновлению во время инференса, а не только во время обучения.
