...
### Арифметические бенчмарки

#### AdderBoard
Челлендж по созданию наименьшего трансформера для сложения двух 10-значных чисел с точностью ≥99%. Исследует минимальные архитектурные требования для арифметических вычислений. Текущий рекорд: 36 параметров (ручные веса), 311 параметров (обученные). [[../../../specialized/synthetic_task_models/adderboard_arithmetic_benchmark.md]] — подробное описание бенчмарка, leaderboard и ключевых техник.
...
- [[../../ai_contests/neurips_2025.md]] - Награды NeurIPS 2025, включающие исследования эффекта искусственного "hivemind" в LLM и потери разнообразия ответов