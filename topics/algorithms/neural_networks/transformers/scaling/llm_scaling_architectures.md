...
- **Keel**: архитектурный подход к стабилизации обучения за счет Highway-style остаточных соединений, позволяющий масштабировать по глубине более эффективно (см. [[../../normalization_placement.md|Размещение нормализации]])
