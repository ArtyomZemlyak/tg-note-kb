...
![Knowledge Localization and Removal](../../../../media/img_1765346450_aqadlq9rgxfrwel_knowledge_localization_and_removal.jpg) <!-- TODO: Broken image path -->

**Изображение показывает**: Визуализацию процесса локализации и удаления знаний в модели с использованием SGTM.

![Gradient Norms](../../../../media/img_1765346450_aqadlw9rgxfrwel_sradient_norms_image.jpg) <!-- TODO: Broken image path -->

**Изображение показывает**: Нормы градиентов в "забываемых" и "сохраняемых" параметрах во время обучения.

![Forget/Retain Trade-off](../../../../media/img_1765346450_aqadlg9rgxfrwel_forget_retain_trade_off_image.jpg) <!-- TODO: Broken image path -->
