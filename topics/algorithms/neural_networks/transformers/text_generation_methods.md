...
- **Примеры**: 
  - [[inference/speculative_decoding.md]] - Использование помощника для предсказания токенов, проверяемых основной моделью
...
- [[hybrid_generation_architectures.md]] - Более подробное рассмотрение гибридных архитектур генерации
