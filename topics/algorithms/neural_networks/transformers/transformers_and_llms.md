...
- **Диффузионные архитектуры**: Используют принципы диффузии с архитектурой трансформера для генерации текста, например, через многократное маскирование и восстановление (см. [[../../../ai/diffusion_models/llm_diffusion_integration.md]] - общее описание диффузионных моделей и [[../../../ai/diffusion_models/architectures/text_diffusion_models.md]] - альтернативный подход к генерации текста с использованием encoder-only архитектуры).
