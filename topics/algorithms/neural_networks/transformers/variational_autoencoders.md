...
### Сравнение с FAE
FAE (Feature Auto-Encoder) представляет альтернативный подход к созданию латентных представлений, фокусируясь на адаптации предобученных визуальных энкодеров через минимальную архитектуру (один слой self-attention), в отличие от VAE, которые обучают энкодер и декодер с нуля.
...
- Кодирование изображений в мультимодальных LLM (например, VAE из Stable Diffusion 1.5 в X-Fusion для преобразования изображений в латентное пространство)
...
- [[../../specialized/computer_vision/feature_adaptation/feature_auto_encoder_fae.md]] - Современный подход к созданию латентных представлений через адаптацию предобученных энкодеров
- [[generative_models.md]] - Общие принципы генеративных моделей
- [[x_fusion.md]] - Использование VAE из Stable Diffusion 1.5 для кодирования изображений в мультимодальной архитектуре
- [[diffusion_llm_integration.md]] - Интеграция VAE в диффузионные архитектуры LLM
- [[../../computer_vision/diffusion_models/minimax_vtp_visual_tokenizer.md]] - Новейшая технология, улучшающая качество визуального токенизатора, преодолевающая ограничения традициональных VAE в диффузионных моделях
- [[../../computer_vision/diffusion_models/autoencoder_diffusability_improvement.md]] - Улучшение диффузабельности латентных пространств автоэнкодеров для более эффективного обучения диффузионных моделей
