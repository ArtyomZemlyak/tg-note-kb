...
- [[../../tools/dllm_library.md]] - Библиотека DLLM для реализации и обучения диффузионных языковых моделей
- [[../interpretability/dlm_scope_sae.md]] - DLM-Scope: первый фреймворк интерпретируемости на основе SAE для диффузионных языковых моделей