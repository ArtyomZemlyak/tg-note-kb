...
[[minimax_vtp_visual_tokenizer.md]] - Альтернативный подход к визуальному токенизатору, который улучшает качество латентного пространства, в отличие от PixelDiT, который отказывается от латентной диффузии
