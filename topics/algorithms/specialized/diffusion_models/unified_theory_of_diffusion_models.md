...
- [[../llm_diffusion_integration.md|Диффузионные модели]] - общее описание диффузионных моделей
...
- [[memorization_vs_generalization.md|Меморизация против обобщения]] - современные открытия о временных шкалах в обучении диффузионных моделей