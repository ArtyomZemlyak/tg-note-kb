...
Kimi K2 Thinking - улучшенная версия модели, получившая широкое признание за свои выдающиеся способности к вызову инструментов. Эта версия вызывает особый интерес из-за своих продвинутых возможностей автономного планирования и выполнения сложных многошаговых задач.
...
### Продвинутый вызов инструментов

Kimi K2 Thinking может выполнять до 200-300 последовательных вызовов инструментов, включая интернет-поиск, браузинг, интерпретаторы кода и другие инструменты. Это позволяет модели решать крайне сложные многошаговые задачи автономно.

### Автономное планирование

Модель обладает способностью к самопланированию:
- Самостоятельно разбивает сложные задачи на подзадачи
- Определяет последовательность вызовов инструментов
- Адаптирует план в процессе решения на основе промежуточных результатов

### Выдающиеся результаты на сложных бенчмарках

- **Humanity's Last Exam**: Достигает SOTA (state-of-the-art) результатов
- **BrowseComp**: Показывает выдающиеся результаты благодаря продвинутым возможностям веб-браузинга
- Эти результаты в основном достижимы благодаря мега-прокаченным возможностям вызова инструментов

### Архитектура

- **MoE (Mixture of Experts)**: Использует архитектуру с 1 триллионом общих параметров и 32 миллиардами активных параметров
- **Контекст**: 128 000 токенов
- **Лицензия**: MIT с небольшими ограничениями для крупных продуктов
- Выход Kimi K2 Thinking окрестили "DeepSeek moment 2.0" в AI-сообществе
...
- [[../../agents/advanced_tool_calling_and_planning.md|Продвинутый вызов инструментов]] - Подробное объяснение возможностей вызова инструментов в Kimi K2 Thinking
- [[../../agents/challenging_benchmarks_for_agents.md|Сложные бенчмарки]] - Бенчмарки, на которых Kimi K2 Thinking показывает SOTA результаты
- [[../deployment/kimi_k2_thinking_hardware_requirements.md|Требования к оборудованию]] - Детали по развертыванию Kimi K2 Thinking и требованиям к оборудованию для локального запуска
- [[../research_advances/kimi_k2_thinking_market_positioning.md|Рыночная позиция]] - Анализ бенчмарк-результатов и конкурентных преимуществ Kimi K2 Thinking