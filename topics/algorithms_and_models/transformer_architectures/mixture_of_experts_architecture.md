...
- **ZAYA1 (Zyphra)**: Первая MoE модель, полностью обученная на стеке AMD (Instinct GPU, ROCm), с 8.3 млрд. параметров и 800 млн. активных параметров, использующая инновационный Compressed Convolutional Attention механизм внимания
