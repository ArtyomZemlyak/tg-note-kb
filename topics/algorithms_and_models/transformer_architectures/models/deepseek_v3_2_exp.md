...
## Подготовка к агентным задачам

DeepSeek-V3.2-Exp служит промежуточной ступенью в разработке архитектур следующего поколения, включая подготовку к агентным задачам. Экспериментальная версия использовалась для проверки технологий, которые впоследствии были улучшены в полноценной версии V3.2. Модель стала основой для мультиагентной системы, которая генерирует обучающие данные для подготовки агентов к поисковым, кодинговым и общим задачам.
...
- [[agent_training_with_synthetic_data.md]] - использование в подготовке агентных систем
- [[thinking_retention_mechanism.md]] - механизм сохранения мышления для будущих версий