...
![Исследователь работает над проектом безопасности ИИ, пытающийся предотвратить reward hacking](../../../media/img_1763909412_aqadhg5rgwbigel_suman_m_working_on_an.jpg) <!-- TODO: Broken image path -->
...
- [[artificial_hivemind/index.md]] - Исследование, показывающее, как системы вознаграждения могут привести к однородности и потере разнообразия в ответах LLM
