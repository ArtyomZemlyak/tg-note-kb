...
В этой категории рассматриваются различные аспекты ИИ-агентов, включая агентов кода, системы планирования и оркестраторы моделей.
...
- [[best_practices_general_ai_agents|Общие лучшие практики ИИ-агентов]] - основные рекомендации по разработке и внедрению агентов в различных приложениях
...
- [[tool_usage|Использование инструментов]] - общая информация о вызове инструментов в ИИ-агентах
