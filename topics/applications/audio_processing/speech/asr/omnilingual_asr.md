...
Недавние разработки от Alibaba - [[qwen3_asr/qwen3_asr_model.md|Qwen3-ASR]] - также представляют конкурентоспособное решение в области ASR, поддерживая распознавание речи на 52 языках и диалектах. Qwen3-ASR включает в себя как флагманскую модель Qwen3-ASR-1.7B для высокого качества, так и компактную версию Qwen3-ASR-0.6B для эффективности и низкой задержки, что делает его подходящим для различных сценариев использования.
