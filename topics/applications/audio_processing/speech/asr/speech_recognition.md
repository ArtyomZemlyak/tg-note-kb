...
### Qwen3-ASR и Qwen3-ForcedAligner
Недавние разработки от Alibaba включают мощное семейство моделей распознавания речи Qwen3-ASR, включающее Qwen3-ASR-1.7B и Qwen3-ASR-0.6B. Эти модели поддерживают распознавание речи на 52 языках и диалектах, обеспечивая конкурентоспособное качество по сравнению с коммерческими решениями. Также была представлена Qwen3-ForcedAligner-0.6B - модель для точного сопоставления текста и аудио, дающая аккуратные таймкоды на уровне слов и фраз для 11 языков.
...
- [[../nlp/silero-stress.md]] - Библиотека для расстановки ударений
...
- [[../nlp/whisper.md]] - Эталонная модель распознавания речи от OpenAI, с которой сравнивается Omnilingual ASR
