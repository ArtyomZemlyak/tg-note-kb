...
![Масштабируемый пайплайн получения данных для S2ST](../../../../../media/img_1763641211_aqadwg5rg0wl8uh_scalable_data_acquisition_pipeline_for.jpg) <!-- TODO: Broken image path -->
...
![Потери на токен при тренировке и задержка предсказания](../../../../../media/img_1763641211_aqadwq5rg0wl8uh_during_training_per_token_loss_is.jpg) <!-- TODO: Broken image path -->
...
- [[../nlp/whisper.md]] - Модель с поддержкой перевода речи для сравнения с подходом Google
