...
![Пример оценки позы с помощью OpenPose](../../../media/img_1764687829_aqaddqxrgx3veel_image.jpg) <!-- TODO: Broken image path -->

**Изображение показывает:** Пример применения оценки позы с использованием OpenPose для создания скелетной структуры.

![Сравнение 2D и 3D референсов для позы](../../../media/img_1764687829_aqaddgxrgx3veel_7b7c5dc8d2111b5e2dafff58cbda4d8b.jpg) <!-- TODO: Broken image path -->

**Изображение показывает:** Сравнение использования 2D и 3D референсов для контроля позы в генерации изображений.

![Пример трансформации персонажа с сохранением позы](../../../media/img_1764687829_aqaddwxrgx3veel_image_image.jpg) <!-- TODO: Broken image path -->
