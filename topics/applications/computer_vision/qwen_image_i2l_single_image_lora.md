...
3. [Диффузионные модели и LoRA оптимизация](../../algorithms/neural_networks/transformers/lora_optimization.md) <!-- TODO: Broken link --> - контекст для понимания роли LoRA в генерации изображений
