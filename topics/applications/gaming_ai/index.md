...
[[track_embedding_representations.md]] - Эмбеддинги трассы/пути для агентов: кодирование трассы в латентное пространство, графовые представления, VAE для траекторий, применение в гоночных играх
