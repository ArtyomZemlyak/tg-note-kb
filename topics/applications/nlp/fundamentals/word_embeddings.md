...
Это открытие стало основой для понимания "[гипотезы линейности](../../../ai/foundations/linearity_hypothesis.md) <!-- TODO: Broken link -->" в нейронных сетях.
...
- [[../../../ai/interpretability/representation_geometry/symmetry_in_language_statistics.md|Симметрия в языковой статистике]] — Теория, объясняющая происхождение геометрических структур в эмбеддингах через трансляционную симметрию в ко-оккурентности слов
- [[../../../ai/interpretability/representation_geometry/index.md|Геометрия представлений]] — Направление геометрической интерпретируемости, изучающее пространственные структуры в активациях моделей
