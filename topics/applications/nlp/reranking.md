...
- Модель мультимодального реранжирования от Alibaba
- Часть фреймворка Qwen3
- Способна оценивать релевантность пар запрос-документ, где оба элемента могут быть текстовыми или визуальными
- Позволяет использовать мультимодальный реранжинг в RAG-системах
