...
![TIGER: Transformer Index for Generative Recommenders](../../../../media/img_1764244291_aqadmgxrg8dukel_tiger_transformer_index_for_generative.jpg) <!-- TODO: Broken image path -->
...
### 3. Ранжирование с хешированием Semantic IDs

- Использование под-компонентов SID как признаков в моделях ранжирования
- Хеширование префиксов SID для улучшения обобщающей способности
- Значительное улучшение работы с холодным стартом и хвостовыми айтемами
- См. подробнее: [[../research_papers/2024_2025_articles/better_generalization_semantic_ids.md]]
...
- [[research_papers/2024_2025_articles/better_generalization_semantic_ids.md]] - Better Generalization: применение SIDs в ранжировании с хешированием под-компонентов
