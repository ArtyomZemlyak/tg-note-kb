...
![PO: Recommendation as Language Processing](../../../../media/img_1764244291_aqadmaxrg8dukel_po_recommendation_as_language_processing.jpg) <!-- TODO: Broken image path -->
...
### OpenOneRec (Kuaishou)
- Открытый фремворк для фундаментальных рекомендательных моделей
- Включает OneRec-Foundation (1.7B и 8B параметров)
- Представляет RecIF-Bench: голистический бенчмарк для задач с инструкциями
- Использует иерархическую itemic tokenization для представления айтемов
- Включает комплексную методологию обучения: предобучение + пост-обучение
- Демонстрирует эмпирические законы масштабирования в рекомендациях
...
- [[llm_in_recsys_production_pipeline|Итеративный пайплайн внедрения LLM в RecSys для Production]] - пошаговое руководство по итеративному внедрению
- [[../foundations/openonerec/main.md]] - OpenOneRec: новое поколение фундаментальных моделей для генеративных рекомендаций