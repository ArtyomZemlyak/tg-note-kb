...
**Count-Min Sketch** - вероятностная структура данных, используемая для эффективной оценки частот элементов в потоках данных, особенно полезная при работе с миллиардами уникальных ID.

**Применение в ИИ**:
- Оценка частот элементов в рекомендательных системах
- Коррекция logQ и семплирование негативов пропорционально популярности
- Мониторинг популярности контента в реальном времени
- См. подробности в [[../../../ai/recsys/count_min_sketch.md|Count-Min Sketch]]
...
- Историческое значение: долгое время считался пределом эффективности для задачи поиска кратчайших путей из одной точки
