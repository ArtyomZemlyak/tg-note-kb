# Навигация по базе знаний
  ...
  - ai:
    - agents:
      ...
      - ai/agents/agent_response_format.md
      - ai/agents/agent_response_format_question.md
      - ai/agents/agent_training_with_synthetic_data.md
      - ai/agents/ai_agent_benchmarks.md
      - ai/agents/alphaevolve_system.md
      - ai/agents/alphaevolve_vs_funsearch_comparison.md
      - ai/agents/alpharesearch_benchmark.md
      - ai/agents/alpharesearch_system.md
      ...
      - ai/agents/dr_tulu_deep_research_agent.md
      - ai/agents/funsearch_system.md
      - ai/agents/general_agentic_memory_gam.md
      ...
      - ai/agents/sciagent_unified_multi_agent_system.md
      - sgr_framework:
    ...
    - applications:
      - ai/applications/ai_in_education.md
      - ai/applications/alphaxiv.md
      - ai/applications/automatic_content_generation.md
      - financial_reasoning:
        - ai/applications/financial_reasoning/financial_reasoning_tasks.md
      - ai/applications/no_code_ai_integrations.md
      - ai/applications/offline_vs_online_processing.md
    ...
    - computer_vision:
      ...
      - diffusion_models:
        - ai/computer_vision/diffusion_models/fastvideo_framework.md
        - ai/computer_vision/diffusion_models/lightx2v_framework.md
        ...
        - ai/computer_vision/diffusion_models/sglang_diffusion.md
      ...
      - ai/computer_vision/zimage_turbo_training_adapter.md
    - ai/consciousness_in_ai.md
    - ai/consistency_models.md
    - continual_learning:
      - catastrophic_forgetting:
        - ai/continual_learning/catastrophic_forgetting/catastrophic_forgetting.md
      - class_incremental_learning:
        - ai/continual_learning/class_incremental_learning/class_incremental_learning.md
        - ai/continual_learning/class_incremental_learning/memo_2022.md
      - ai/continual_learning/continuum_memory_system.md
      - ai/continual_learning/hope_architecture.md
      - ai/continual_learning/nested_learning.md
      - ai/continual_learning/nested_learning_applications.md
      - ai/continual_learning/nested_learning_vs_titans_comparison.md
      - plasticity:
        - ai/continual_learning/plasticity/continual_backpropagation.md
        - ai/continual_learning/plasticity/dormant_units.md
        - ai/continual_learning/plasticity/loss_of_plasticity.md
      - rehearsal:
        - ai/continual_learning/rehearsal/experience_replay.md
      - ai/continual_learning/titan_architecture.md
    - ai/critical_thinking.md
    - diffusion_models:
      - ai/diffusion_models/memorization_vs_generalization.md
    - distributed_systems:
      - ai/distributed_systems/ulysses_context_parallelism_method.md
    - ai/dreamer.md
    - ai/dreamer4.md
    - embedders:
      - ai/embedders/embedding_dimension_vs_combinations.md
      - ai/embedders/embedding_retrieval_theoretical_limits.md
      - ai/embedders/matryoshka_representation_learning.md
    - ai/embodied_ai.md
    - ai/flow_matching.md
    - graphs:
      - ai/graphs/cayleypy.md
      - ai/graphs/computational_group_theory.md
      - gLSTM:
        - ai/graphs/gLSTM/gLSTM.md
      - ai/graphs/gnn_architectures.md
      - ai/graphs/graph_property_prediction.md
      - ai/graphs/kaggle_competitions.md
      - ai/graphs/knowledge_graphs.md
      - ai/graphs/long_range_dependencies.md
      - ai/graphs/mathematical_conjectures.md
      - ai/graphs/neighbor_associative_recall.md
      - ai/graphs/over_squashing.md
      - ai/graphs/wikontic.md
      - ai/graphs/xLSTM_inspiration.md
    - hardware:
      - ai/hardware/amd_ai_stack.md
      - ai/hardware/anthropic_tpu_cluster.md
      - ai/hardware/aws_efa_networking_for_ai.md
      - ai/hardware/openai_broadcom_partnership.md
    - kan:
      - ai/kan/README.md
      - applications:
        - ai/kan/applications/scientific_computing.md
      - architectures:
        - ai/kan/architectures/kan_architecture.md
      - basis_functions:
        - ai/kan/basis_functions/basis_functions_overview.md
      - mathematics:
        - ai/kan/mathematics/kolmogorov_arnold_theorem.md
      - optimization:
        - ai/kan/optimization/training_strategies.md
      - theory:
        - ai/kan/theory/fundamentals.md
    - llm:
      - ai/llm/activation_engineering.md
      - ai/llm/alternative_attention_mechanisms_comparison.md
      - applications:
        - code_generation_agents:
          ...
          - ai/llm/applications/code_generation_agents/transformation_to_engineering_agents.md
        - ai/llm/applications/content_moderation.md
        - ai/llm/applications/llm_market_research.md
        - ai/llm/applications/llm_scientific_research.md
        - ai/llm/applications/minimax_m2_coding_capabilities.md
        - ai/llm/applications/pymc_labs_focus_groups.md
        - ai/llm/applications/yandex_neural_editing.md
      - architectures:
        - ai/llm/architectures/attention_sink_phenomenon.md
        - ai/llm/architectures/attention_sink_token_composition_effects.md
        - ai/llm/architectures/attention_sinks_in_transformer_models.md
        ...
        - diffusion:
          - ai/llm/architectures/diffusion/bert_diffusion_connection.md
          - ai/llm/architectures/diffusion/bert_generative_conversion.md
          - ai/llm/architectures/diffusion/diffusion_llm_architectures.md
          - ai/llm/architectures/diffusion/discrete_diffusion_architecture.md
          - experiments:
            - ai/llm/architectures/diffusion/experiments/rumodernbert_diffusion_experiments.md
          - ai/llm/architectures/diffusion/gemini_diffusion.md
          - models:
            - ai/llm/architectures/diffusion/models/bert_diffusion_models.md
          - ai/llm/architectures/diffusion/planned_diffusion.md
          - ai/llm/architectures/diffusion/roberta_diffusion_generation.md
          - ai/llm/architectures/diffusion/soft_masked_diffusion_models.md
          - ai/llm/architectures/diffusion/text_diffusion_models.md
          - ai/llm/architectures/diffusion/tidar_method.md
        - ai/llm/architectures/dynamic_moe_routing_hymba.md
        - ai/llm/architectures/dynamic_sparsity_approaches.md
        - ai/llm/architectures/encoder_decoder_vs_decoder_only.md
        - ai/llm/architectures/flash_attention_and_grouped_mechanisms.md
        - ai/llm/architectures/gated_attention_mechanism.md
        - ai/llm/architectures/gated_deltanet.md
        - ai/llm/architectures/gemma_3.md
        - ai/llm/architectures/glm_45.md
        - ai/llm/architectures/gpt_oss.md
        - ai/llm/architectures/gpt_oss_safeguard.md
        - ai/llm/architectures/grok_25.md
        - ai/llm/architectures/hybrid_architectures.md
        - ai/llm/architectures/hybrid_efficient_llm_architectures.md
        - ai/llm/architectures/kimi_delta_attention.md
        - ai/llm/architectures/kimi_k2.md
        - ai/llm/architectures/linear_sequence_modeling.md
        - ai/llm/architectures/llama_4.md
        - ai/llm/architectures/lmm_long_term_memory_module.md
        - ai/llm/architectures/looped_architectures.md
        - ai/llm/architectures/looped_transformers.md
        - ai/llm/architectures/mac_mag_mal_architectures.md
        - ai/llm/architectures/mamba_3_architecture.md
        - ai/llm/architectures/mamba_3_mathematical_foundation.md
        ...
        - ai/llm/architectures/multi_head_latent_attention.md
        - ai/llm/architectures/nemotron_elastic_architecture.md
        - ai/llm/architectures/next_gen_architectures_comparison.md
        - ai/llm/architectures/no_positional_embeddings.md
        - ai/llm/architectures/olmo_2.md
        - ai/llm/architectures/qk_normalization.md
        - ai/llm/architectures/qwen3.md
        - ai/llm/architectures/qwen3_next.md
        - ai/llm/architectures/retnet_architecture.md
        - ai/llm/architectures/rwkv_architecture.md
        - ai/llm/architectures/sliding_window_attention.md
        - ai/llm/architectures/smollm3.md
        - ai/llm/architectures/sparse_gating_mechanism_attention_sink_mitigation.md
      ...
      - ai/llm/goodharts_law_application_in_ai.md
      ...
      - hallucination_detection:
        ...
        - ai/llm/hallucination_detection/hallucinations_in_llm.md
        - ai/llm/hallucination_detection/psiloqa.md
      - ai/llm/hybrid_generation_architectures.md
      - ai/llm/hyperscale_evolution_strategies.md
      - inference:
        ...
        - ai/llm/inference/token_level_scheduling.md
        - ai/llm/inference/vllm_inference_optimization.md
        - ai/llm/inference/vllm_integration.md
        - ai/llm/inference/vllm_sleep_mode.md
        - ai/llm/inference/vllm_summary.md
      ...
      - memory:
        ...
        - ai/llm/memory/llm_long_term_memory.md
        - ai/llm/memory/llm_memory_overview.md
        - ai/llm/memory/mcp_model_context_protocol.md
      - ai/llm/mixture_of_experts_architecture.md
      ...
      - models:
        ...
        - ai/llm/models/anthropic_haiku_4_5.md
        ...
        - multimodal:
          ...
          - ai/llm/models/multimodal/ming_family_evolution.md
          - ai/llm/models/multimodal/ming_flash_omni_preview.md
          - ai/llm/models/multimodal/multimodal_architecture_comparison.md
          - ai/llm/models/multimodal/omnivinci.md
          - ai/llm/models/multimodal/qwen3-omni-audio-processing.md
          - ai/llm/models/multimodal/qwen3-omni-training-methodology.md
          - ai/llm/models/multimodal/qwen3-omni-video-processing.md
          - ai/llm/models/multimodal/qwen3-omni.md
          - ai/llm/models/multimodal/tuna_unified_multimodal_model.md
          - ai/llm/models/multimodal/vqgan_decoder.md
          - ai/llm/models/multimodal/x_fusion.md
        - ai/llm/models/nanoGPT.md
        - ai/llm/models/nvidia_llama_3_nemotron_super_49b_v15.md
        - qwen:
          - ai/llm/models/qwen/qwen-vl-series.md
          - ai/llm/models/qwen/qwen3-vl.md
          - ai/llm/models/qwen/qwen_deepresearch_2511.md
          - ai/llm/models/qwen/vlm_models.md
        - ai/llm/models/qwen_omni_models.md
      ...
      - optimization:
        - ai/llm/optimization/calm_efficiency_approach.md
      ...
      - prompt_engineering:
        - ai/llm/prompt_engineering/cot_synthesis_approaches.md
        - ai/llm/prompt_engineering/cot_variants.md
      - ai/llm/prompt_engineering.md
      - pruning:
        - ai/llm/pruning/structured_pruning.md
      - reasoning:
        - ai/llm/reasoning/attribution_graphs_interpretability.md
        - ai/llm/reasoning/circuit_based_reasoning_verification.md
        - ai/llm/reasoning/coconut_chain_of_continuous_thought.md
        - ai/llm/reasoning/coconut_vs_other_reasoning_approaches.md
        - ai/llm/reasoning/computational_graphs_in_llm_reasoning.md
        - ai/llm/reasoning/confidence_measurements_in_llm_reasoning.md
        - ai/llm/reasoning/crv_ecosystem_overview.md
        - ai/llm/reasoning/deepconf_deep_think_with_confidence.md
        - ai/llm/reasoning/deepconf_offline_vs_online_modes.md
        ...
        - ai/llm/reasoning/llm_computational_efficiency_deepconf.md
        ...
        - ai/llm/reasoning/supervised_reinforcement_learning_srl.md
      ...
      - tools:
        ...
        - ai/llm/tools/dllm_library.md
        - ai/llm/tools/hugginggpt.md
        - ai/llm/tools/lplb_linear_programming_load_balancer.md
        - ai/llm/tools/metatool_framework.md
        - ai/llm/tools/miles_rl_framework.md
      ...
      - training:
        ...
        - ai/llm/training/instruction_following_improvements.md
        - ai/llm/training/tool_calling_improvements.md
    ...
    - meta_learning:
      ...
      - ai/meta_learning/learning_to_optimize.md
      - ai/meta_learning/maml_rl.md
      - ai/meta_learning/meta_learning.md
      - ai/meta_learning/meta_rl.md
      - ai/meta_learning/reptile_rl.md
    - ai/minecraft_ai.md
    - multimodal:
      - ai/multimodal/omni_modal_ai_developments.md
    - ai/neuro_symbolic_systems.md
    - nlp:
      - applications:
        - ai/nlp/applications/llm_market_research.md
        - ai/nlp/applications/market_research.md
        - ai/nlp/applications/sentiment_analysis.md
      - embedders:
        - models:
      ...
      - transformers:
        ...
        - ai/nlp/transformers/mat_taxonomy.md
        - ai/nlp/transformers/memory_augmented_transformers.md
    ...
    - ocr:
      ...
      - ai/ocr/deepseek_ocr.md
      - ai/ocr/deepseek_ocr_rs.md
      - ai/ocr/deepseek_ocr_training_process.md
      - ai/ocr/dynamic_resolution_approaches.md
    ...
    - optimization:
      ...
      - ai/optimization/deep_optimizers.md
      - ai/optimization/evolutionary_algorithms.md
      - ai/optimization/genetic_algorithms.md
      - ai/optimization/gigaevo_framework.md
      - ai/optimization/incremental_learning.md
      - ai/optimization/isosceles_triangles_grid.md
      - ai/optimization/kakeya_nikodym_sets.md
      - ai/optimization/kissing_numbers.md
      - ai/optimization/kld_dangers_in_distribution_optimization.md
      - ai/optimization/mathematical_optimization_problems.md
      - ai/optimization/matrix_whitening_optimizers.md
      - ai/optimization/memory_efficient_training.md
      - ai/optimization/muon_optimizer.md
      - ai/optimization/optimizer_quantization_relationship.md
      - ai/optimization/packing_problems.md
      - ai/optimization/qat_modern_methods.md
      - quantization:
        - ai/optimization/quantization/int_vs_fp_quantization_comparison.md
      - ai/optimization/shampoo_optimizer.md
      - ai/optimization/soap_optimizer.md
      - ai/optimization/sofa_problem.md
    ...
    - rag:
      ...
      - ai/rag/contextual_retrieval.md
    ...
    - recsys:
      ...
      - ai/recsys/chinese_market_competition.md
      - ai/recsys/cikm_25.md
      - ai/recsys/cikm_25_insights.md
      - ai/recsys/count_min_sketch.md
      - ai/recsys/das_dual_aligned_semantic_ids.md
      - ai/recsys/dcn_v2_architecture.md
      - ai/recsys/denserec.md
      - ai/recsys/end_to_end_generative_recommendation_systems.md
      ...
      - llm_based:
        - ai/recsys/llm_based/FLARE.md
        - ai/recsys/llm_based/LUMEN.md
        - concept:
          - ai/recsys/llm_based/concept/analyze.md
          - ai/recsys/llm_based/concept/analyze_concepts.md
          - ai/recsys/llm_based/concept/concept_adaptive_user_layers.md
        ...
        - ai/recsys/llm_based/hybrid_strategy_dynamic_updates.md
        - ai/recsys/llm_based/linkedin_compressed_llm_approach.md
        - ai/recsys/llm_based/linkedin_large_scale_retrieval.md
        - ai/recsys/llm_based/llm4rec_survey_classification.md
        - ai/recsys/llm_based/llm_candidate_generation_approaches.md
        - ai/recsys/llm_based/llm_feature_encoders.md
        - ai/recsys/llm_based/llm_feature_engineering.md
        - ai/recsys/llm_based/llm_pipeline_controller.md
        - ai/recsys/llm_based/llm_rec_new_research.md
        - ai/recsys/llm_based/llm_scoring_ranking_functions.md
        ...
        - onepiece_framework:
          ...
          - ai/recsys/llm_based/onepiece_framework/progressive_training.md
          - ai/recsys/llm_based/onepiece_framework/reasoning_approach.md
          - ai/recsys/llm_based/onepiece_framework/retrieval_ranking.md
        - onerec_think:
          - ai/recsys/llm_based/onerec_think/main.md
      ...
      - ai/recsys/onetrans_unified_model.md
      - ai/recsys/pinnerformer_pinrec_architectures.md
      - ai/recsys/ple_architecture.md
      ...
      - ai/recsys/target_aware_architectures_in_ranking.md
      - ai/recsys/tbgrecall.md
    ...
    - reinforcement_learning:
      ...
      - deep_rl:
        - ai/reinforcement_learning/deep_rl/deep_rl_algorithms.md
        - ai/reinforcement_learning/deep_rl/deep_rl_courses_comparison.md
        - ai/reinforcement_learning/deep_rl/deep_scaling_contrastive_rl.md
    ...
    - research_advances:
      ...
      - reasoning_models:
        - ai/research_advances/reasoning_models/attention_head_architecture.md
        - ai/research_advances/reasoning_models/hierarchical_reasoning_model_hrm.md
        - ai/research_advances/reasoning_models/hrm_critique_analysis.md
        - interruptible_lrms:
          - ai/research_advances/reasoning_models/interruptible_lrms/evaluation_framework_dynamic.md
          - ai/research_advances/reasoning_models/interruptible_lrms/failure_modes_lrm.md
          - ai/research_advances/reasoning_models/interruptible_lrms/frozen_world_assumption.md
          - ai/research_advances/reasoning_models/interruptible_lrms/real_world_applications.md
        - ai/research_advances/reasoning_models/mathematical_reasoning_limitations.md
        - ai/research_advances/reasoning_models/tiny_recursive_model_trm.md
        - ai/research_advances/reasoning_models/trm_architecture.md
        - ai/research_advances/reasoning_models/trm_experiments_results.md
    ...
    - scientific_ml:
      ...
      - pinn:
        - ai/scientific_ml/pinn/applications.md
    ...
    - speech:
      - asr:
        - ai/speech/asr/discrete_flow_matching_asr.md
        - ai/speech/asr/drax.md
    ...
    - theory:
      ...
      - ai/theory/implicit_dynamical_regularization.md
      - ai/theory/less_is_more_philosophy.md
      - ai/theory/linearity_hypothesis.md
      - ai/theory/unified_theory_of_diffusion_models.md
    - tools:
      - ai/tools/ai_toolkit_by_ostris.md
      - ai/tools/alphaxiv_tensor_trace.md
      - ai/tools/chatgpt_atlas.md
      - ai/tools/claude_code.md
      - ai/tools/cursor.md
      - ai/tools/cursor_composer.md
      - ai/tools/cursor_vs_qwen_code.md
      - ai/tools/distributed_training_pytorch.md
      - ai/tools/docling.md
      - ai/tools/docling_error_ocrconfig.md
      - ai/tools/docling_error_pdfpipelineoptions.md
      - ai/tools/docling_error_rapidocr_backend.md
      - ai/tools/docling_error_tesseract_psm.md
      - ai/tools/docling_error_tesserocr_config.md
      - ai/tools/dr_agent_lib.md
      - ai/tools/executorch.md
      - ai/tools/gelato.md
      - ai/tools/ggml.md
      - ai/tools/happy_coder.md
      - icx360:
        - ai/tools/icx360/cell.md
        - ai/tools/icx360/hierarchical_explanations.md
        - ai/tools/icx360/perturbation_methods.md
        - ai/tools/icx360/token_highlighter.md
      - ai/tools/kernel_programming_pytorch.md
      - llm_gw:
        - ai/tools/llm_gw/bifrost.md
        - ai/tools/llm_gw/litellm.md
      - ai/tools/lmms_engine.md
      - ai/tools/mem0_framework.md
      - ai/tools/memoryos_framework.md
      - ai/tools/mini_sglang_framework.md
      - ai/tools/n8n.md
      - ai/tools/niche_open_source_tools_for_scientific_literature.md
      - ai/tools/prompt_engineering_for_coding.md
      - ai/tools/pytorch_monarch.md
      - ai/tools/qwen_code.md
  ...
  - math:
    ...
    - math/fundamentals_statistics_probability.md
    - math/grid_problems.md
    - math/imo_2025_problem_6.md
    - math/linear_algebra.md
  - media:
    - media/img_1763352310_aqadgxjrg6oayeh_from_cache_false_document_key_a0b301f2d8.md
    - media/img_1763352310_aqadhbjrg6oayeh9_from_cache_false_document_key_02e5302c7e.md
    - media/img_1763352310_aqadhhjrg6oayeh_from_cache_false_document_key_55db3898ae.md
    - media/img_1763352310_aqadhrjrg6oayeh_from_cache_false_document_key_02bf4b5757.md
    - media/img_1763352310_aqadhxjrg6oayeh_from_cache_false_document_key_1aeea31f19.md
    - media/img_1763352310_aqadibjrg6oayeh_from_cache_false_document_key_2f3b9361ff.md
    - media/img_1763352311_aqadirjrg6oayeh_from_cache_false_document_key_157f36a9b9.md
    - media/img_1763352311_aqadixjrg6oayeh9_from_cache_false_document_key_212d3d5dcd.md
    - media/img_1763352311_aqadjbjrg6oayeh_from_cache_false_document_key_279ebc7f17.md
    - media/img_1764121718_aqad6gtrgxqlkel_image.md
  - nav.md
  - programming:
    - data_formats:
      - programming/data_formats/json_format.md
      - programming/data_formats/toon_format.md
      - programming/data_formats/toon_specification.md
    - python:
      - performance:
        - programming/python/performance/performance_python_3_15.md
      - profiling:
        - programming/python/profiling/sampling_profiler.md
      - programming/python/python_3_15.md
      - typing:
        - programming/python/typing/typing_python_3_15.md
    - software_architecture:
      - programming/software_architecture/SOLID_principles.md
      - programming/software_architecture/bm25_search_algorithm.md
      - programming/software_architecture/git_best_practices.md
      - programming/software_architecture/git_complete_guide.md
      - programming/software_architecture/git_divergent_branches_troubleshooting.md
      - programming/software_architecture/git_merge_conflicts_resolution.md
      - programming/software_architecture/git_synchronization_errors.md
  ...
  - temp:
    - temp/empty_request.md
    - temp/temp_image_description.md
    - temp/test_content.md
    - temp/test_message_response.md
