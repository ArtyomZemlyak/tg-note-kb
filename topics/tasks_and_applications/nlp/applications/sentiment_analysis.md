...
- [[../models/bert.md]] - модель, применяемая для анализа тональности
- [[ai/nlp/models/gpt4.md]] - современная модель, способная к анализу тональности через промпт-инжиниринг
- [[ai/nlp/russian_slang_isho.md]] - русский сленг и его влияние на анализ тональности
- [[ai/llm/applications/yandex_neural_editing.md]] - пример использования LLM для создания контента, который может включать анализ тональности
