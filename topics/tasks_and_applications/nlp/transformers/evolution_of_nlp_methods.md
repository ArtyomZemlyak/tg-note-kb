...
- **Диффузионные модели**: Современное направление, показывающее, что BERT по сути является одностадийной диффузионной моделью (см. [[../../llm/architectures/diffusion/bert_diffusion_connection.md]] - новое понимание связи между классическим маскированным языковым моделированием и диффузионными процессами).
