...
- **xLSTM**: расширенная архитектура LSTM, вдохновившая gLSTM [[../../graphs/xLSTM_inspiration.md|xLSTM вдохновение]]
...
- **Диффузионные модели**: Современное направление, показывающее, что BERT по сути является одностадийной диффузионной моделью (см. [[../../../ai/diffusion_models/architectures/bert_diffusion_connection.md]] - новое понимание связи между классическим маскированным языковым моделированием и диффузионными процессами).
