...
- **Диффузионные трансформеры**: Модели, использующие принципы диффузии с архитектурой трансформера для генерации, например, через многократное маскирование и восстановление (см. [[../../llm/diffusion_models.md]] - общее описание диффузионных моделей, [[../../../ai/diffusion_models/computer_vision/diffusion_transformer.md]] - DiT (Diffusion Transformer) для генерации изображений, и [[../../../ai/diffusion_models/architectures/text_diffusion_models.md]] - альтернативный подход к генерации текста с использованием encoder-only архитектуры)
