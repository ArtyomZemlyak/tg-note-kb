...
- [[unified_embeddings.md]] - Альтернативный подход к решению проблемы масштаба эмбеддинг-таблиц
- [[llm_based/main.md]] - LLM-базированные рекомендательные системы: альтернативный подход к решению подобных проблем
- [[count_min_sketch.md]] - Структура данных для оценки частот элементов, полезная для решения проблем масштаба в рекомендательных системах