...
Подход, схожий с RQ-VAE, используется в других мультимодальных системах, таких как [[../../llm/models/multimodal/loong_video_generation.md|Loong]], где мультимодальные данные (текст и видео) объединяются в единой архитектуре токенизации.
